...
pub enum FUNCSEL_A {
    ...
    PIO1 = 7,
    #[doc = "8: Connect to PIO2 peripheral"]
    PIO2 = 8,
    #[doc = "9: Connect to GPCK peripheral"]
    GPCK = 9,
    #[doc = "10: Connect to USB peripheral"]
    USB = 10,
    #[doc = "11: Connect to matching UART_AUX peripheral"]
    UART_AUX = 11,
...
impl FUNCSEL_R {
    ...
    pub const fn variant(&self) -> Option<FUNCSEL_A> {
        match self.bits {
            ...
            8 => Some(FUNCSEL_A::PIO2),
            9 => Some(FUNCSEL_A::GPCK),
            10 => Some(FUNCSEL_A::USB),
            11 => Some(FUNCSEL_A::UART_AUX),
    ...
    #[doc = "Connect to PIO2 peripheral"]
    #[inline(always)]
    pub fn is_pio2(&self) -> bool {
        *self == FUNCSEL_A::PIO2
    }
    #[doc = "Connect to GPCK peripheral"]
    #[inline(always)]
    pub fn is_gpck(&self) -> bool {
        *self == FUNCSEL_A::GPCK
    }
    ...
    #[doc = "Connect to matching UART_AUX peripheral"]
    #[inline(always)]
    pub fn is_uart_aux(&self) -> bool {
        *self == FUNCSEL_A::UART_AUX
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Connect to PIO2 peripheral"]
    #[inline(always)]
    pub fn pio2(self) -> &'a mut crate::W<REG> {
        self.variant(FUNCSEL_A::PIO2)
    }
    #[doc = "Connect to GPCK peripheral"]
    #[inline(always)]
    pub fn gpck(self) -> &'a mut crate::W<REG> {
        self.variant(FUNCSEL_A::GPCK)
    }
    #[doc = "Connect to USB peripheral"]
    #[inline(always)]
    ...
    #[doc = "Connect to matching UART_AUX peripheral"]
    #[inline(always)]
    pub fn uart_aux(self) -> &'a mut crate::W<REG> {
        self.variant(FUNCSEL_A::UART_AUX)
    }
    #[doc = "Connect to nothing"]
    #[inline(always)]
