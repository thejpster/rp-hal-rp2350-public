#[doc = "Register `IRQSUMMARY_DORMANT_WAKE_SECURE1` reader"]
pub type R = crate::R<IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC>;
#[doc = "Register `IRQSUMMARY_DORMANT_WAKE_SECURE1` writer"]
pub type W = crate::W<IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC>;
...
pub struct IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC;
impl crate::RegisterSpec for IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irqsummary_dormant_wake_secure1::R`](R) reader structure"]
impl crate::Readable for IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`irqsummary_dormant_wake_secure1::W`](W) writer structure"]
impl crate::Writable for IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IRQSUMMARY_DORMANT_WAKE_SECURE1 to value 0"]
impl crate::Resettable for IRQSUMMARY_DORMANT_WAKE_SECURE1_SPEC {
