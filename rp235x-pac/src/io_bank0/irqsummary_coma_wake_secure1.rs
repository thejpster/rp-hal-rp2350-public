#[doc = "Register `IRQSUMMARY_COMA_WAKE_SECURE1` reader"]
pub type R = crate::R<IRQSUMMARY_COMA_WAKE_SECURE1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`irqsummary_coma_wake_secure1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IRQSUMMARY_COMA_WAKE_SECURE1_SPEC;
impl crate::RegisterSpec for IRQSUMMARY_COMA_WAKE_SECURE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irqsummary_coma_wake_secure1::R`](R) reader structure"]
impl crate::Readable for IRQSUMMARY_COMA_WAKE_SECURE1_SPEC {}
#[doc = "`reset()` method sets IRQSUMMARY_COMA_WAKE_SECURE1 to value 0"]
impl crate::Resettable for IRQSUMMARY_COMA_WAKE_SECURE1_SPEC {
