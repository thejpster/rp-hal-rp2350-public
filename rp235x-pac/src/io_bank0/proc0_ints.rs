...
#[doc = "Register `PROC0_INTS%s` writer"]
pub type W = crate::W<PROC0_INTS_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`proc0_ints::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`proc0_ints::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`proc0_ints::W`](W) writer structure"]
impl crate::Writable for PROC0_INTS_SPEC {
