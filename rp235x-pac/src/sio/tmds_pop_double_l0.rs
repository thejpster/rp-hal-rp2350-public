...
#[doc = "Register `TMDS_POP_DOUBLE_L0` writer"]
pub type W = crate::W<TMDS_POP_DOUBLE_L0_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`tmds_pop_double_l0::W`](W) writer structure"]
impl crate::Writable for TMDS_POP_DOUBLE_L0_SPEC {
