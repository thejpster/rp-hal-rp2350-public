...
impl core::fmt::Debug for crate::generic::Reg<TMDS_POP_DOUBLE_L1_SPEC> {
...
You can [`read`](crate::Reg::read) this register and get [`tmds_pop_double_l1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).  
