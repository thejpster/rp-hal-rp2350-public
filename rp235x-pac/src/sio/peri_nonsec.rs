...
#[doc = "Field `INTERP0` reader - If 1, detach interpolator 0 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type INTERP0_R = crate::BitReader;
#[doc = "Field `INTERP0` writer - If 1, detach interpolator 0 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type INTERP0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INTERP1` reader - If 1, detach interpolator 1 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type INTERP1_R = crate::BitReader;
#[doc = "Field `INTERP1` writer - If 1, detach interpolator 1 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type INTERP1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TMDS` reader - IF 1, detach TMDS encoder (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type TMDS_R = crate::BitReader;
#[doc = "Field `TMDS` writer - IF 1, detach TMDS encoder (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
pub type TMDS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - If 1, detach interpolator 0 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
    #[inline(always)]
    pub fn interp0(&self) -> INTERP0_R {
        INTERP0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - If 1, detach interpolator 1 (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
    #[inline(always)]
    pub fn interp1(&self) -> INTERP1_R {
        INTERP1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 5 - IF 1, detach TMDS encoder (of this core) from the Secure SIO, and attach to the NonSecure SIO."]
    #[inline(always)]
