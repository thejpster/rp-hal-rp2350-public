...
#[doc = "Register `TMDS_POP_SINGLE` writer"]
pub type W = crate::W<TMDS_POP_SINGLE_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`tmds_pop_single::W`](W) writer structure"]
impl crate::Writable for TMDS_POP_SINGLE_SPEC {
