...
#[doc = "Register `INTERP1_POP_LANE0` writer"]
pub type W = crate::W<INTERP1_POP_LANE0_SPEC>;
#[doc = "Field `INTERP1_POP_LANE0` reader - "]
pub type INTERP1_POP_LANE0_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn interp1_pop_lane0(&self) -> INTERP1_POP_LANE0_R {
        INTERP1_POP_LANE0_R::new(self.bits)
    }
}
impl W {}
...
#[doc = "`write(|w| ..)` method takes [`interp1_pop_lane0::W`](W) writer structure"]
impl crate::Writable for INTERP1_POP_LANE0_SPEC {
