...
#[doc = "Register `TMDS_PEEK_DOUBLE_L1` writer"]
pub type W = crate::W<TMDS_PEEK_DOUBLE_L1_SPEC>;
#[doc = "Field `TMDS_PEEK_DOUBLE_L1` reader -   

<div class=\"warning\">The field is <b>modified</b> in some way after a read operation.</div>"]
pub type TMDS_PEEK_DOUBLE_L1_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn tmds_peek_double_l1(&self) -> TMDS_PEEK_DOUBLE_L1_R {
        TMDS_PEEK_DOUBLE_L1_R::new(self.bits)
    }
}
impl W {}
...
#[doc = "`write(|w| ..)` method takes [`tmds_peek_double_l1::W`](W) writer structure"]
impl crate::Writable for TMDS_PEEK_DOUBLE_L1_SPEC {
