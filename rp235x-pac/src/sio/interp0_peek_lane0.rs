...
#[doc = "Register `INTERP0_PEEK_LANE0` writer"]
pub type W = crate::W<INTERP0_PEEK_LANE0_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`interp0_peek_lane0::W`](W) writer structure"]
impl crate::Writable for INTERP0_PEEK_LANE0_SPEC {
