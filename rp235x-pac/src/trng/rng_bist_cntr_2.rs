#[doc = "Register `RNG_BIST_CNTR_2` reader"]
pub type R = crate::R<RNG_BIST_CNTR_2_SPEC>;
#[doc = "Register `RNG_BIST_CNTR_2` writer"]
pub type W = crate::W<RNG_BIST_CNTR_2_SPEC>;
...
pub struct RNG_BIST_CNTR_2_SPEC;
impl crate::RegisterSpec for RNG_BIST_CNTR_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rng_bist_cntr_2::R`](R) reader structure"]
impl crate::Readable for RNG_BIST_CNTR_2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rng_bist_cntr_2::W`](W) writer structure"]
impl crate::Writable for RNG_BIST_CNTR_2_SPEC {
