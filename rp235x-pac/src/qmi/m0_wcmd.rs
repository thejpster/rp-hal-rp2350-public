#[doc = "Register `M0_WCMD` reader"]
pub type R = crate::R<M0_WCMD_SPEC>;
#[doc = "Register `M0_WCMD` writer"]
pub type W = crate::W<M0_WCMD_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`m0_wcmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m0_wcmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M0_WCMD_SPEC;
impl crate::RegisterSpec for M0_WCMD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m0_wcmd::R`](R) reader structure"]
impl crate::Readable for M0_WCMD_SPEC {}
#[doc = "`write(|w| ..)` method takes [`m0_wcmd::W`](W) writer structure"]
impl crate::Writable for M0_WCMD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets M0_WCMD to value 0xa002"]
impl crate::Resettable for M0_WCMD_SPEC {
