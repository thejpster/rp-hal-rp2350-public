#[doc = "Register `M0_RCMD` reader"]
pub type R = crate::R<M0_RCMD_SPEC>;
#[doc = "Register `M0_RCMD` writer"]
pub type W = crate::W<M0_RCMD_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`m0_rcmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m0_rcmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M0_RCMD_SPEC;
impl crate::RegisterSpec for M0_RCMD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m0_rcmd::R`](R) reader structure"]
impl crate::Readable for M0_RCMD_SPEC {}
