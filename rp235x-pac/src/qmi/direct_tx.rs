#[doc = "Register `DIRECT_TX` reader"]
pub type R = crate::R<DIRECT_TX_SPEC>;
#[doc = "Register `DIRECT_TX` writer"]
pub type W = crate::W<DIRECT_TX_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`direct_tx::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`direct_tx::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIRECT_TX_SPEC;
impl crate::RegisterSpec for DIRECT_TX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`direct_tx::R`](R) reader structure"]
impl crate::Readable for DIRECT_TX_SPEC {}
