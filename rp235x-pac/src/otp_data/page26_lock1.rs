#[doc = "Register `PAGE26_LOCK1` reader"]
pub type R = crate::R<PAGE26_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page26_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE26_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE26_LOCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page26_lock1::R`](R) reader structure"]
impl crate::Readable for PAGE26_LOCK1_SPEC {}
#[doc = "`reset()` method sets PAGE26_LOCK1 to value 0"]
impl crate::Resettable for PAGE26_LOCK1_SPEC {
