#[doc = "Register `PAGE51_LOCK1` reader"]
pub type R = crate::R<PAGE51_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page51_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE51_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE51_LOCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page51_lock1::R`](R) reader structure"]
impl crate::Readable for PAGE51_LOCK1_SPEC {}
#[doc = "`reset()` method sets PAGE51_LOCK1 to value 0"]
impl crate::Resettable for PAGE51_LOCK1_SPEC {
