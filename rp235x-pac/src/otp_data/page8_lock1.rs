#[doc = "Register `PAGE8_LOCK1` reader"]
pub type R = crate::R<PAGE8_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page8_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE8_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE8_LOCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page8_lock1::R`](R) reader structure"]
impl crate::Readable for PAGE8_LOCK1_SPEC {}
#[doc = "`reset()` method sets PAGE8_LOCK1 to value 0"]
impl crate::Resettable for PAGE8_LOCK1_SPEC {
