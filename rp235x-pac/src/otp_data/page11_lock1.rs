#[doc = "Register `PAGE11_LOCK1` reader"]
pub type R = crate::R<PAGE11_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page11_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE11_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE11_LOCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page11_lock1::R`](R) reader structure"]
impl crate::Readable for PAGE11_LOCK1_SPEC {}
#[doc = "`reset()` method sets PAGE11_LOCK1 to value 0"]
impl crate::Resettable for PAGE11_LOCK1_SPEC {
