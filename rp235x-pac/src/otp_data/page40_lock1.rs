#[doc = "Register `PAGE40_LOCK1` reader"]
pub type R = crate::R<PAGE40_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page40_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE40_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE40_LOCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page40_lock1::R`](R) reader structure"]
impl crate::Readable for PAGE40_LOCK1_SPEC {}
#[doc = "`reset()` method sets PAGE40_LOCK1 to value 0"]
impl crate::Resettable for PAGE40_LOCK1_SPEC {
