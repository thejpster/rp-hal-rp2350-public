...
#[doc = "Field `ENABLE_BOOTSEL_NON_DEFAULT_PLL_XOSC_CFG` reader - Enable loading of the non-default XOSC and PLL configuration before entering BOOTSEL mode.  
...
#[doc = "Field `OVERRIDE_FLASH_PARTITION_SLOT_SIZE` reader - Override the limit for default flash metadata scanning.  
...
#[doc = "Field `ENABLE_OTP_BOOT` reader - Enable OTP boot. A number of OTP rows specified by OTPBOOT_LEN will be loaded, starting from OTPBOOT_SRC, into the SRAM location specified by OTPBOOT_DST1 and OTPBOOT_DST0.  
...
#[doc = "Field `DISABLE_XIP_ACCESS_ON_SRAM_ENTRY` reader - "]
...
impl R {
    ...
    #[doc = "Bit 2 - Enable loading of the non-default XOSC and PLL configuration before entering BOOTSEL mode.  
 ...
 If this bit is set, user software may use the contents of BOOTSEL_PLL_CFG to calculated the expected XOSC frequency based on the fixed USB boot frequency of 48 MHz."]
    ...
    #[doc = "Bit 3 - If 1, configure the QSPI pads for 1.8 V operation when accessing flash for the first time from the bootrom, using the VOLTAGE_SELECT register for the QSPI pads bank. This slightly improves the input timing of the pads at low voltages, but does not affect their output characteristics.  
 ...
 If 0, leave VOLTAGE_SELECT in its reset state (suitable for operation at and above 2.5 V)"]
    ...
    #[doc = "Bit 6 - Override the limit for default flash metadata scanning.  
 ...
 The value is specified in FLASH_PARTITION_SLOT_SIZE. Make sure FLASH_PARTITION_SLOT_SIZE is valid before setting this bit"]
    ...
    #[doc = "Bit 14 - Enable OTP boot. A number of OTP rows specified by OTPBOOT_LEN will be loaded, starting from OTPBOOT_SRC, into the SRAM location specified by OTPBOOT_DST1 and OTPBOOT_DST0.  
...
You can [`read`](crate::Reg::read) this register and get [`boot_flags0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
