#[doc = "Register `PAGE35_LOCK1` reader"]
pub type R = crate::R<PAGE35_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page35_lock1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE35_LOCK1_SPEC;
impl crate::RegisterSpec for PAGE35_LOCK1_SPEC {
    type Ux = u32;
}
