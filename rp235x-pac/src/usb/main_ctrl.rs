...
#[doc = "Field `PHY_ISO` reader - Isolates USB phy after controller power-up Remove isolation once software has configured the controller Not isolated = 0, Isolated = 1"]
pub type PHY_ISO_R = crate::BitReader;
#[doc = "Field `PHY_ISO` writer - Isolates USB phy after controller power-up Remove isolation once software has configured the controller Not isolated = 0, Isolated = 1"]
pub type PHY_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn phy_iso(&self) -> PHY_ISO_R {
        PHY_ISO_R::new(((self.bits >> 2) & 1) != 0)
    }
