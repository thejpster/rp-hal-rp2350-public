...
#[doc = "Field `TX_DP_OE` reader - Output enable. If TX_DIFFMODE=1, OE for DPP/DPM diff pair. 0 - DPP/DPM in Hi-Z state; 1 - DPP/DPM driving If TX_DIFFMODE=0, OE for DPP only. 0 - DPP in Hi-Z state; 1 - DPP driving"]
pub type TX_DP_OE_R = crate::BitReader;
#[doc = "Field `TX_DP_OE` writer - Output enable. If TX_DIFFMODE=1, OE for DPP/DPM diff pair. 0 - DPP/DPM in Hi-Z state; 1 - DPP/DPM driving If TX_DIFFMODE=0, OE for DPP only. 0 - DPP in Hi-Z state; 1 - DPP driving"]
pub type TX_DP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DM_OE` reader - Output enable. If TX_DIFFMODE=1, Ignored. If TX_DIFFMODE=0, OE for DPM only. 0 - DPM in Hi-Z state; 1 - DPM driving"]
pub type TX_DM_OE_R = crate::BitReader;
#[doc = "Field `TX_DM_OE` writer - Output enable. If TX_DIFFMODE=1, Ignored. If TX_DIFFMODE=0, OE for DPM only. 0 - DPM in Hi-Z state; 1 - DPM driving"]
pub type TX_DM_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DP` reader - Output data. If TX_DIFFMODE=1, Drives DPP/DPM diff pair. TX_DP_OE=1 to enable drive. DPP=TX_DP, DPM=~TX_DP If TX_DIFFMODE=0, Drives DPP only. TX_DP_OE=1 to enable drive. DPP=TX_DP"]
pub type TX_DP_R = crate::BitReader;
#[doc = "Field `TX_DP` writer - Output data. If TX_DIFFMODE=1, Drives DPP/DPM diff pair. TX_DP_OE=1 to enable drive. DPP=TX_DP, DPM=~TX_DP If TX_DIFFMODE=0, Drives DPP only. TX_DP_OE=1 to enable drive. DPP=TX_DP"]
pub type TX_DP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DM` reader - Output data. TX_DIFFMODE=1, Ignored TX_DIFFMODE=0, Drives DPM only. TX_DM_OE=1 to enable drive. DPM=TX_DM"]
pub type TX_DM_R = crate::BitReader;
#[doc = "Field `TX_DM` writer - Output data. TX_DIFFMODE=1, Ignored TX_DIFFMODE=0, Drives DPM only. TX_DM_OE=1 to enable drive. DPM=TX_DM"]
...
#[doc = "Field `TX_FSSLEW` reader - TX_FSSLEW=0: Low speed slew rate TX_FSSLEW=1: Full speed slew rate"]
pub type TX_FSSLEW_R = crate::BitReader;
#[doc = "Field `TX_FSSLEW` writer - TX_FSSLEW=0: Low speed slew rate TX_FSSLEW=1: Full speed slew rate"]
pub type TX_FSSLEW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DIFFMODE` reader - TX_DIFFMODE=0: Single ended mode TX_DIFFMODE=1: Differential drive mode (TX_DM, TX_DM_OE ignored)"]
pub type TX_DIFFMODE_R = crate::BitReader;
#[doc = "Field `TX_DIFFMODE` writer - TX_DIFFMODE=0: Single ended mode TX_DIFFMODE=1: Differential drive mode (TX_DM, TX_DM_OE ignored)"]
...
pub type RX_DD_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_DP_OVERRIDE` reader - Override rx_dp value into controller"]
pub type RX_DP_OVERRIDE_R = crate::BitReader;
#[doc = "Field `RX_DP_OVERRIDE` writer - Override rx_dp value into controller"]
pub type RX_DP_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_DM_OVERRIDE` reader - Override rx_dm value into controller"]
pub type RX_DM_OVERRIDE_R = crate::BitReader;
#[doc = "Field `RX_DM_OVERRIDE` writer - Override rx_dm value into controller"]
pub type RX_DM_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn rx_dd_override(&self) -> RX_DD_OVERRIDE_R {
        RX_DD_OVERRIDE_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Override rx_dp value into controller"]
    #[inline(always)]
    pub fn rx_dp_override(&self) -> RX_DP_OVERRIDE_R {
        RX_DP_OVERRIDE_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Override rx_dm value into controller"]
    #[inline(always)]
    pub fn rx_dm_override(&self) -> RX_DM_OVERRIDE_R {
        RX_DM_OVERRIDE_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable the second DP pull up resistor. 0 - Pull = Rpu2; 1 - Pull = Rpu1 + Rpu2"]
