...
#[doc = "Field `EP0_STOP_ON_SHORT_PACKET` reader - Device: Stop EP0 on a short packet."]
pub type EP0_STOP_ON_SHORT_PACKET_R = crate::BitReader;
#[doc = "Field `EP0_STOP_ON_SHORT_PACKET` writer - Device: Stop EP0 on a short packet."]
pub type EP0_STOP_ON_SHORT_PACKET_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 19 - Device: Stop EP0 on a short packet."]
    #[inline(always)]
    pub fn ep0_stop_on_short_packet(&self) -> EP0_STOP_ON_SHORT_PACKET_R {
        EP0_STOP_ON_SHORT_PACKET_R::new(((self.bits >> 19) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep0_stop_on_short_packet(&mut self) -> EP0_STOP_ON_SHORT_PACKET_W<SIE_CTRL_SPEC> {
        EP0_STOP_ON_SHORT_PACKET_W::new(self, 19)
    }
    #[doc = "Bit 24 - Direct control of DM"]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets SIE_CTRL to value 0x8000"]
