...
#[doc = "Field `HDLSIM` reader - Indicates the platform is a simulation"]
...
impl R {
    ...
    #[doc = "Bit 2 - Indicates the platform is a simulation"]
    #[inline(always)]
...
#[doc = "`reset()` method sets PLATFORM to value 0x01"]
