...
impl SRC_R {
    ...
    pub const fn variant(&self) -> SRC_A {
        match self.bits {
            0 => SRC_A::ROSC_CLKSRC_PH,
            1 => SRC_A::CLKSRC_CLK_REF_AUX,
            2 => SRC_A::XOSC_CLKSRC,
            3 => SRC_A::LPOSC_CLKSRC,
            _ => unreachable!(),
        }
    }
    #[doc = "`0`"]
    ...
    pub fn is_lposc_clksrc(&self) -> bool {
        *self == SRC_A::LPOSC_CLKSRC
    }
}
#[doc = "Field `SRC` writer - Selects the clock source glitchlessly, can be changed on-the-fly"]
pub type SRC_W<'a, REG> = crate::FieldWriter<'a, REG, 2, SRC_A, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn lposc_clksrc(self) -> &'a mut crate::W<REG> {
        self.variant(SRC_A::LPOSC_CLKSRC)
    }
}
...
impl AUXSRC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> AUXSRC_A {
        match self.bits {
            0 => AUXSRC_A::CLKSRC_PLL_USB,
            1 => AUXSRC_A::CLKSRC_GPIN0,
            2 => AUXSRC_A::CLKSRC_GPIN1,
            3 => AUXSRC_A::CLKSRC_PLL_USB_PRIMARY_REF_OPCG,
            _ => unreachable!(),
        }
    }
    #[doc = "`0`"]
...
pub type AUXSRC_W<'a, REG> = crate::FieldWriter<'a, REG, 2, AUXSRC_A, crate::Safe>;
