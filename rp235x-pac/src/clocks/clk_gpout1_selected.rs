...
#[doc = "Register `CLK_GPOUT1_SELECTED` writer"]
pub type W = crate::W<CLK_GPOUT1_SELECTED_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`clk_gpout1_selected::W`](W) writer structure"]
impl crate::Writable for CLK_GPOUT1_SELECTED_SPEC {
