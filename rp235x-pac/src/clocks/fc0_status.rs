...
#[doc = "Register `FC0_STATUS` writer"]
pub type W = crate::W<FC0_STATUS_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`fc0_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fc0_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`fc0_status::W`](W) writer structure"]
impl crate::Writable for FC0_STATUS_SPEC {
