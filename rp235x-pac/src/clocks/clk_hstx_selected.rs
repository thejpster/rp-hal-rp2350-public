...
#[doc = "Register `CLK_HSTX_SELECTED` writer"]
pub type W = crate::W<CLK_HSTX_SELECTED_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`clk_hstx_selected::W`](W) writer structure"]
impl crate::Writable for CLK_HSTX_SELECTED_SPEC {
