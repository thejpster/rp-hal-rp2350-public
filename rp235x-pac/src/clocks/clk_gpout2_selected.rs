...
#[doc = "Register `CLK_GPOUT2_SELECTED` writer"]
pub type W = crate::W<CLK_GPOUT2_SELECTED_SPEC>;
#[doc = "Field `CLK_GPOUT2_SELECTED` reader - This slice does not have a glitchless mux (only the AUX_SRC field is present, not SRC) so this register is hardwired to 0x1."]
pub type CLK_GPOUT2_SELECTED_R = crate::BitReader;
impl R {
...
#[doc = "`write(|w| ..)` method takes [`clk_gpout2_selected::W`](W) writer structure"]
impl crate::Writable for CLK_GPOUT2_SELECTED_SPEC {
