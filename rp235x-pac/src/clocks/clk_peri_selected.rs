...
#[doc = "Register `CLK_PERI_SELECTED` writer"]
pub type W = crate::W<CLK_PERI_SELECTED_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`clk_peri_selected::W`](W) writer structure"]
impl crate::Writable for CLK_PERI_SELECTED_SPEC {
