...
#[doc = "Register `CLK_USB_SELECTED` writer"]
pub type W = crate::W<CLK_USB_SELECTED_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`clk_usb_selected::W`](W) writer structure"]
impl crate::Writable for CLK_USB_SELECTED_SPEC {
