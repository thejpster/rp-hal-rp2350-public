...
pub type CLK_GPOUT0_SELECTED_R = crate::BitReader;
impl R {
    ...
    pub fn clk_gpout0_selected(&self) -> CLK_GPOUT0_SELECTED_R {
        CLK_GPOUT0_SELECTED_R::new((self.bits & 1) != 0)
    }
}
#[doc = "Indicates which src is currently selected (one-hot)  

You can [`read`](crate::Reg::read) this register and get [`clk_gpout0_selected::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
