...
#[doc = "Field `clk_sys_sram6` writer - "]
pub type CLK_SYS_SRAM6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_sram7` reader - "]
pub type CLK_SYS_SRAM7_R = crate::BitReader;
#[doc = "Field `clk_sys_sram7` writer - "]
pub type CLK_SYS_SRAM7_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_sram8` reader - "]
pub type CLK_SYS_SRAM8_R = crate::BitReader;
#[doc = "Field `clk_sys_sram8` writer - "]
pub type CLK_SYS_SRAM8_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_sram9` reader - "]
pub type CLK_SYS_SRAM9_R = crate::BitReader;
#[doc = "Field `clk_sys_sram9` writer - "]
pub type CLK_SYS_SRAM9_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `clk_ref_ticks` writer - "]
pub type CLK_REF_TICKS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_ticks` reader - "]
pub type CLK_SYS_TICKS_R = crate::BitReader;
#[doc = "Field `clk_sys_ticks` writer - "]
pub type CLK_SYS_TICKS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_timer0` reader - "]
pub type CLK_SYS_TIMER0_R = crate::BitReader;
#[doc = "Field `clk_sys_timer0` writer - "]
pub type CLK_SYS_TIMER0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_timer1` reader - "]
pub type CLK_SYS_TIMER1_R = crate::BitReader;
#[doc = "Field `clk_sys_timer1` writer - "]
pub type CLK_SYS_TIMER1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clk_sys_trng` reader - "]
pub type CLK_SYS_TRNG_R = crate::BitReader;
#[doc = "Field `clk_sys_trng` writer - "]
pub type CLK_SYS_TRNG_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `clk_usb` writer - "]
pub type CLK_USB_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_peri_spi0(&mut self) -> CLK_PERI_SPI0_W<WAKE_EN1_SPEC> {
        CLK_PERI_SPI0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_spi0(&mut self) -> CLK_SYS_SPI0_W<WAKE_EN1_SPEC> {
        CLK_SYS_SPI0_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn clk_peri_spi1(&mut self) -> CLK_PERI_SPI1_W<WAKE_EN1_SPEC> {
        CLK_PERI_SPI1_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_spi1(&mut self) -> CLK_SYS_SPI1_W<WAKE_EN1_SPEC> {
        CLK_SYS_SPI1_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram0(&mut self) -> CLK_SYS_SRAM0_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM0_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram1(&mut self) -> CLK_SYS_SRAM1_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM1_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram2(&mut self) -> CLK_SYS_SRAM2_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM2_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram3(&mut self) -> CLK_SYS_SRAM3_W<WAKE_EN1_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram6(&mut self) -> CLK_SYS_SRAM6_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM6_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram7(&mut self) -> CLK_SYS_SRAM7_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM7_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram8(&mut self) -> CLK_SYS_SRAM8_W<WAKE_EN1_SPEC> {
        CLK_SYS_SRAM8_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_sram9(&mut self) -> CLK_SYS_SRAM9_W<WAKE_EN1_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_ref_ticks(&mut self) -> CLK_REF_TICKS_W<WAKE_EN1_SPEC> {
        CLK_REF_TICKS_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_ticks(&mut self) -> CLK_SYS_TICKS_W<WAKE_EN1_SPEC> {
        CLK_SYS_TICKS_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_timer0(&mut self) -> CLK_SYS_TIMER0_W<WAKE_EN1_SPEC> {
        CLK_SYS_TIMER0_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_timer1(&mut self) -> CLK_SYS_TIMER1_W<WAKE_EN1_SPEC> {
        CLK_SYS_TIMER1_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn clk_sys_trng(&mut self) -> CLK_SYS_TRNG_W<WAKE_EN1_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_usb(&mut self) -> CLK_USB_W<WAKE_EN1_SPEC> {
...
#[doc = "`reset()` method sets WAKE_EN1 to value 0x7fff_ffff"]
