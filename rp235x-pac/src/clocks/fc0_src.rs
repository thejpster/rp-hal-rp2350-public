...
impl FC0_SRC_R {
    ...
    pub const fn variant(&self) -> Option<FC0_SRC_A> {
        match self.bits {
            ...
            13 => Some(FC0_SRC_A::CLK_HSTX),
            14 => Some(FC0_SRC_A::LPOSC_CLKSRC),
            15 => Some(FC0_SRC_A::OTP_CLK2FC),
            16 => Some(FC0_SRC_A::PLL_USB_CLKSRC_PRIMARY_DFT),
            _ => None,
        }
    }
    #[doc = "`0`"]
    ...
    pub fn is_clk_hstx(&self) -> bool {
        *self == FC0_SRC_A::CLK_HSTX
    }
    #[doc = "`1110`"]
    #[inline(always)]
    pub fn is_lposc_clksrc(&self) -> bool {
        *self == FC0_SRC_A::LPOSC_CLKSRC
    }
    #[doc = "`1111`"]
    #[inline(always)]
    pub fn is_otp_clk2fc(&self) -> bool {
        *self == FC0_SRC_A::OTP_CLK2FC
    }
    #[doc = "`10000`"]
    #[inline(always)]
    pub fn is_pll_usb_clksrc_primary_dft(&self) -> bool {
        *self == FC0_SRC_A::PLL_USB_CLKSRC_PRIMARY_DFT
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn clk_hstx(self) -> &'a mut crate::W<REG> {
        self.variant(FC0_SRC_A::CLK_HSTX)
    }
    #[doc = "`1110`"]
    #[inline(always)]
    pub fn lposc_clksrc(self) -> &'a mut crate::W<REG> {
        self.variant(FC0_SRC_A::LPOSC_CLKSRC)
    }
    #[doc = "`1111`"]
    #[inline(always)]
    pub fn otp_clk2fc(self) -> &'a mut crate::W<REG> {
        self.variant(FC0_SRC_A::OTP_CLK2FC)
    }
    #[doc = "`10000`"]
    #[inline(always)]
    pub fn pll_usb_clksrc_primary_dft(self) -> &'a mut crate::W<REG> {
        self.variant(FC0_SRC_A::PLL_USB_CLKSRC_PRIMARY_DFT)
    }
}
impl R {
    #[doc = "Bits 0:7"]
