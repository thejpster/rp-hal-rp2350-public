#[doc = "Register `CLK_HSTX_CTRL` reader"]
pub type R = crate::R<CLK_HSTX_CTRL_SPEC>;
#[doc = "Register `CLK_HSTX_CTRL` writer"]
pub type W = crate::W<CLK_HSTX_CTRL_SPEC>;
...
impl AUXSRC_R {
    ...
    pub const fn variant(&self) -> Option<AUXSRC_A> {
        match self.bits {
            ...
            3 => Some(AUXSRC_A::CLKSRC_GPIN0),
            4 => Some(AUXSRC_A::CLKSRC_GPIN1),
            _ => None,
        }
    }
    #[doc = "`0`"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn auxsrc(&mut self) -> AUXSRC_W<CLK_HSTX_CTRL_SPEC> {
        AUXSRC_W::new(self, 5)
    }
    #[doc = "Bit 10 - Asynchronously kills the clock generator, enable must be set low before deasserting kill"]
    #[inline(always)]
    #[must_use]
    pub fn kill(&mut self) -> KILL_W<CLK_HSTX_CTRL_SPEC> {
        KILL_W::new(self, 10)
    }
    #[doc = "Bit 11 - Starts and stops the clock generator cleanly"]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<CLK_HSTX_CTRL_SPEC> {
        ENABLE_W::new(self, 11)
    }
    #[doc = "Bits 16:17 - This delays the enable signal by up to 3 cycles of the input clock This must be set before the clock is enabled to have any effect"]
    #[inline(always)]
    #[must_use]
    pub fn phase(&mut self) -> PHASE_W<CLK_HSTX_CTRL_SPEC> {
        PHASE_W::new(self, 16)
    }
    #[doc = "Bit 20 - An edge on this signal shifts the phase of the output by 1 cycle of the input clock This can be done at any time"]
    #[inline(always)]
    #[must_use]
    pub fn nudge(&mut self) -> NUDGE_W<CLK_HSTX_CTRL_SPEC> {
        NUDGE_W::new(self, 20)
    }
}
#[doc = "Clock control, can be changed on-the-fly (except for auxsrc)  

You can [`read`](crate::Reg::read) this register and get [`clk_hstx_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`clk_hstx_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CLK_HSTX_CTRL_SPEC;
impl crate::RegisterSpec for CLK_HSTX_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_hstx_ctrl::R`](R) reader structure"]
impl crate::Readable for CLK_HSTX_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_hstx_ctrl::W`](W) writer structure"]
impl crate::Writable for CLK_HSTX_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CLK_HSTX_CTRL to value 0"]
impl crate::Resettable for CLK_HSTX_CTRL_SPEC {
