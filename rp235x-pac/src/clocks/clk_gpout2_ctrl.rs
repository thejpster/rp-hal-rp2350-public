...
impl AUXSRC_R {
    ...
    pub const fn variant(&self) -> Option<AUXSRC_A> {
        match self.bits {
            ...
            4 => Some(AUXSRC_A::CLKSRC_PLL_USB_PRIMARY_REF_OPCG),
            5 => Some(AUXSRC_A::ROSC_CLKSRC_PH),
            6 => Some(AUXSRC_A::XOSC_CLKSRC),
            7 => Some(AUXSRC_A::LPOSC_CLKSRC),
            8 => Some(AUXSRC_A::CLK_SYS),
            9 => Some(AUXSRC_A::CLK_USB),
            10 => Some(AUXSRC_A::CLK_ADC),
            11 => Some(AUXSRC_A::CLK_REF),
            12 => Some(AUXSRC_A::CLK_PERI),
            13 => Some(AUXSRC_A::CLK_HSTX),
            14 => Some(AUXSRC_A::OTP_CLK2FC),
            _ => None,
        }
    }
    #[doc = "`0`"]
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn is_clksrc_pll_usb_primary_ref_opcg(&self) -> bool {
        *self == AUXSRC_A::CLKSRC_PLL_USB_PRIMARY_REF_OPCG
    }
    #[doc = "`101`"]
    #[inline(always)]
    ...
    #[doc = "`111`"]
    #[inline(always)]
    pub fn is_lposc_clksrc(&self) -> bool {
        *self == AUXSRC_A::LPOSC_CLKSRC
    }
    #[doc = "`1000`"]
    #[inline(always)]
    ...
    pub fn is_clk_peri(&self) -> bool {
        *self == AUXSRC_A::CLK_PERI
    }
    #[doc = "`1101`"]
    #[inline(always)]
    pub fn is_clk_hstx(&self) -> bool {
        *self == AUXSRC_A::CLK_HSTX
    }
    #[doc = "`1110`"]
    #[inline(always)]
    pub fn is_otp_clk2fc(&self) -> bool {
        *self == AUXSRC_A::OTP_CLK2FC
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn clksrc_pll_usb_primary_ref_opcg(self) -> &'a mut crate::W<REG> {
        self.variant(AUXSRC_A::CLKSRC_PLL_USB_PRIMARY_REF_OPCG)
    }
    #[doc = "`101`"]
    #[inline(always)]
    ...
    #[doc = "`111`"]
    #[inline(always)]
    pub fn lposc_clksrc(self) -> &'a mut crate::W<REG> {
        self.variant(AUXSRC_A::LPOSC_CLKSRC)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    ...
    pub fn clk_peri(self) -> &'a mut crate::W<REG> {
        self.variant(AUXSRC_A::CLK_PERI)
    }
    #[doc = "`1101`"]
    #[inline(always)]
    pub fn clk_hstx(self) -> &'a mut crate::W<REG> {
        self.variant(AUXSRC_A::CLK_HSTX)
    }
    #[doc = "`1110`"]
    #[inline(always)]
    pub fn otp_clk2fc(self) -> &'a mut crate::W<REG> {
        self.variant(AUXSRC_A::OTP_CLK2FC)
    }
}
#[doc = "Field `KILL` reader - Asynchronously kills the clock generator, enable must be set low before deasserting kill"]
pub type KILL_R = crate::BitReader;
#[doc = "Field `KILL` writer - Asynchronously kills the clock generator, enable must be set low before deasserting kill"]
...
#[doc = "Field `DC50` reader - Enables duty cycle correction for odd divisors, can be changed on-the-fly"]
pub type DC50_R = crate::BitReader;
#[doc = "Field `DC50` writer - Enables duty cycle correction for odd divisors, can be changed on-the-fly"]
...
#[doc = "Field `ENABLED` reader - clock generator is enabled"]
...
impl R {
    ...
    #[doc = "Bit 28 - clock generator is enabled"]
    #[inline(always)]
    pub fn enabled(&self) -> ENABLED_R {
        ENABLED_R::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 5:8 - Selects the auxiliary clock source, will glitch when switching"]
