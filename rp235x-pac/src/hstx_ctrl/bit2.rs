#[doc = "Register `BIT2` reader"]
pub type R = crate::R<BIT2_SPEC>;
#[doc = "Register `BIT2` writer"]
pub type W = crate::W<BIT2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sel_p(&mut self) -> SEL_P_W<BIT2_SPEC> {
        SEL_P_W::new(self, 0)
    }
    #[doc = "Bits 8:12 - Shift register data bit select for the second half of the HSTX clock cycle"]
    #[inline(always)]
    #[must_use]
    pub fn sel_n(&mut self) -> SEL_N_W<BIT2_SPEC> {
        SEL_N_W::new(self, 8)
    }
    #[doc = "Bit 16 - Invert this data output (logical NOT)"]
    #[inline(always)]
    #[must_use]
    pub fn inv(&mut self) -> INV_W<BIT2_SPEC> {
        INV_W::new(self, 16)
    }
    #[doc = "Bit 17 - Connect this output to the generated clock, rather than the data shift register. SEL_P and SEL_N are ignored if this bit is set, but INV can still be set to generate an antiphase clock."]
    #[inline(always)]
    #[must_use]
    pub fn clk(&mut self) -> CLK_W<BIT2_SPEC> {
        CLK_W::new(self, 17)
    }
}
#[doc = "Data control register for output bit 2  

You can [`read`](crate::Reg::read) this register and get [`bit2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bit2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BIT2_SPEC;
impl crate::RegisterSpec for BIT2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bit2::R`](R) reader structure"]
impl crate::Readable for BIT2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bit2::W`](W) writer structure"]
impl crate::Writable for BIT2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BIT2 to value 0"]
impl crate::Resettable for BIT2_SPEC {
