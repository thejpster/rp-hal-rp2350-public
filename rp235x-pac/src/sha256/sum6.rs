...
#[doc = "Register `SUM6` writer"]
pub type W = crate::W<SUM6_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`sum6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sum6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`sum6::W`](W) writer structure"]
impl crate::Writable for SUM6_SPEC {
