...
pub struct RegisterBlock {
    ...
    linestate_tuning: LINESTATE_TUNING,
    intr: INTR,
    inte: INTE,
    intf: INTF,
    ints: INTS,
    _reserved25: [u8; 0x64],
    sof_timestamp_raw: SOF_TIMESTAMP_RAW,
    sof_timestamp_last: SOF_TIMESTAMP_LAST,
    sm_state: SM_STATE,
    ep_tx_error: EP_TX_ERROR,
    ep_rx_error: EP_RX_ERROR,
    dev_sm_watchdog: DEV_SM_WATCHDOG,
}
impl RegisterBlock {
    ...
    #[doc = "0x88 - Used for debug only."]
    #[inline(always)]
    pub const fn linestate_tuning(&self) -> &LINESTATE_TUNING {
    ...
    #[doc = "0x100 - Device only. Raw value of free-running PHY clock counter @48MHz. Used to calculate time between SOF events."]
    #[inline(always)]
    pub const fn sof_timestamp_raw(&self) -> &SOF_TIMESTAMP_RAW {
        &self.sof_timestamp_raw
    }
    #[doc = "0x104 - Device only. Value of free-running PHY clock counter @48MHz when last SOF event occurred."]
    #[inline(always)]
    pub const fn sof_timestamp_last(&self) -> &SOF_TIMESTAMP_LAST {
        &self.sof_timestamp_last
    }
    #[doc = "0x108 - "]
    #[inline(always)]
    pub const fn sm_state(&self) -> &SM_STATE {
        &self.sm_state
    }
    #[doc = "0x10c - TX error count for each endpoint. Write to each field to reset the counter to 0."]
    #[inline(always)]
    pub const fn ep_tx_error(&self) -> &EP_TX_ERROR {
        &self.ep_tx_error
    }
    #[doc = "0x110 - RX error count for each endpoint. Write to each field to reset the counter to 0."]
    #[inline(always)]
    pub const fn ep_rx_error(&self) -> &EP_RX_ERROR {
        &self.ep_rx_error
    }
    #[doc = "0x114 - Watchdog that forces the device state machine to idle and raises an interrupt if the device stays in a state that isn't idle for the configured limit. The counter is reset on every state transition. Set limit while enable is low and then set the enable."]
    #[inline(always)]
    pub const fn dev_sm_watchdog(&self) -> &DEV_SM_WATCHDOG {
        &self.dev_sm_watchdog
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`sof_wr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sof_wr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  
...
You can [`read`](crate::Reg::read) this register and get [`sof_rd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sof_rd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  
...
pub mod usbphy_trim;
#[doc = "LINESTATE_TUNING (rw) register accessor: Used for debug only.  

You can [`read`](crate::Reg::read) this register and get [`linestate_tuning::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`linestate_tuning::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@linestate_tuning`]
module"]
pub type LINESTATE_TUNING = crate::Reg<linestate_tuning::LINESTATE_TUNING_SPEC>;
#[doc = "Used for debug only."]
pub mod linestate_tuning;
...
pub mod ints;
#[doc = "SOF_TIMESTAMP_RAW (rw) register accessor: Device only. Raw value of free-running PHY clock counter @48MHz. Used to calculate time between SOF events.  

You can [`read`](crate::Reg::read) this register and get [`sof_timestamp_raw::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sof_timestamp_raw::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@sof_timestamp_raw`]
module"]
pub type SOF_TIMESTAMP_RAW = crate::Reg<sof_timestamp_raw::SOF_TIMESTAMP_RAW_SPEC>;
#[doc = "Device only. Raw value of free-running PHY clock counter @48MHz. Used to calculate time between SOF events."]
pub mod sof_timestamp_raw;
#[doc = "SOF_TIMESTAMP_LAST (rw) register accessor: Device only. Value of free-running PHY clock counter @48MHz when last SOF event occurred.  

You can [`read`](crate::Reg::read) this register and get [`sof_timestamp_last::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sof_timestamp_last::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@sof_timestamp_last`]
module"]
pub type SOF_TIMESTAMP_LAST = crate::Reg<sof_timestamp_last::SOF_TIMESTAMP_LAST_SPEC>;
#[doc = "Device only. Value of free-running PHY clock counter @48MHz when last SOF event occurred."]
pub mod sof_timestamp_last;
#[doc = "SM_STATE (rw) register accessor:   

You can [`read`](crate::Reg::read) this register and get [`sm_state::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm_state::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@sm_state`]
module"]
pub type SM_STATE = crate::Reg<sm_state::SM_STATE_SPEC>;
#[doc = ""]
pub mod sm_state;
#[doc = "EP_TX_ERROR (rw) register accessor: TX error count for each endpoint. Write to each field to reset the counter to 0.  

You can [`read`](crate::Reg::read) this register and get [`ep_tx_error::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ep_tx_error::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@ep_tx_error`]
module"]
pub type EP_TX_ERROR = crate::Reg<ep_tx_error::EP_TX_ERROR_SPEC>;
#[doc = "TX error count for each endpoint. Write to each field to reset the counter to 0."]
pub mod ep_tx_error;
#[doc = "EP_RX_ERROR (rw) register accessor: RX error count for each endpoint. Write to each field to reset the counter to 0.  

You can [`read`](crate::Reg::read) this register and get [`ep_rx_error::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ep_rx_error::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@ep_rx_error`]
module"]
pub type EP_RX_ERROR = crate::Reg<ep_rx_error::EP_RX_ERROR_SPEC>;
#[doc = "RX error count for each endpoint. Write to each field to reset the counter to 0."]
pub mod ep_rx_error;
#[doc = "DEV_SM_WATCHDOG (rw) register accessor: Watchdog that forces the device state machine to idle and raises an interrupt if the device stays in a state that isn't idle for the configured limit. The counter is reset on every state transition. Set limit while enable is low and then set the enable.  

You can [`read`](crate::Reg::read) this register and get [`dev_sm_watchdog::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dev_sm_watchdog::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@dev_sm_watchdog`]
module"]
pub type DEV_SM_WATCHDOG = crate::Reg<dev_sm_watchdog::DEV_SM_WATCHDOG_SPEC>;
