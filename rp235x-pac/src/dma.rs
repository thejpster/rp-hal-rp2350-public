...
impl RegisterBlock {
 ...
 Write an initial seed value here before starting a DMA transfer on the channel indicated by SNIFF_CTRL_DMACH. The hardware will update this register each time it observes a read from the indicated channel. Once the channel completes, the final result can be read from this register."]
    ...
    #[doc = "0x480 - Security configuration for channel 0. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x484 - Security configuration for channel 1. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x488 - Security configuration for channel 2. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x48c - Security configuration for channel 3. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x490 - Security configuration for channel 4. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x494 - Security configuration for channel 5. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x498 - Security configuration for channel 6. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x49c - Security configuration for channel 7. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4a0 - Security configuration for channel 8. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4a4 - Security configuration for channel 9. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4a8 - Security configuration for channel 10. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4ac - Security configuration for channel 11. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4b0 - Security configuration for channel 12. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4b4 - Security configuration for channel 13. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4b8 - Security configuration for channel 14. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4bc - Security configuration for channel 15. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
    ...
    #[doc = "0x4c0 - Security configuration for IRQ 0. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
    #[inline(always)]
    pub const fn seccfg_irq0(&self) -> &SECCFG_IRQ0 {
        &self.seccfg_irq0
    }
    #[doc = "0x4c4 - Security configuration for IRQ 1. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
    #[inline(always)]
    pub const fn seccfg_irq1(&self) -> &SECCFG_IRQ1 {
        &self.seccfg_irq1
    }
    #[doc = "0x4c8 - Security configuration for IRQ 2. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
    #[inline(always)]
    pub const fn seccfg_irq2(&self) -> &SECCFG_IRQ2 {
        &self.seccfg_irq2
    }
    #[doc = "0x4cc - Security configuration for IRQ 3. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
    #[inline(always)]
...
pub mod n_channels;
#[doc = "SECCFG_CH0 (rw) register accessor: Security configuration for channel 0. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 0. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch0;
#[doc = "SECCFG_CH1 (rw) register accessor: Security configuration for channel 1. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 1. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch1;
#[doc = "SECCFG_CH2 (rw) register accessor: Security configuration for channel 2. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 2. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch2;
#[doc = "SECCFG_CH3 (rw) register accessor: Security configuration for channel 3. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 3. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch3;
#[doc = "SECCFG_CH4 (rw) register accessor: Security configuration for channel 4. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 4. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch4;
#[doc = "SECCFG_CH5 (rw) register accessor: Security configuration for channel 5. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 5. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch5;
#[doc = "SECCFG_CH6 (rw) register accessor: Security configuration for channel 6. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 6. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch6;
#[doc = "SECCFG_CH7 (rw) register accessor: Security configuration for channel 7. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 7. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch7;
#[doc = "SECCFG_CH8 (rw) register accessor: Security configuration for channel 8. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 8. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch8;
#[doc = "SECCFG_CH9 (rw) register accessor: Security configuration for channel 9. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 9. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch9;
#[doc = "SECCFG_CH10 (rw) register accessor: Security configuration for channel 10. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 10. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch10;
#[doc = "SECCFG_CH11 (rw) register accessor: Security configuration for channel 11. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 11. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch11;
#[doc = "SECCFG_CH12 (rw) register accessor: Security configuration for channel 12. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 12. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch12;
#[doc = "SECCFG_CH13 (rw) register accessor: Security configuration for channel 13. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 13. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch13;
#[doc = "SECCFG_CH14 (rw) register accessor: Security configuration for channel 14. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 14. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch14;
#[doc = "SECCFG_CH15 (rw) register accessor: Security configuration for channel 15. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
...
#[doc = "Security configuration for channel 15. Control whether this channel performs Secure/NonSecure and Privileged/Unprivileged bus accesses.  
 ...
 This register is world-readable, but is writable only from a Secure, Privileged context."]
pub mod seccfg_ch15;
#[doc = "SECCFG_IRQ0 (rw) register accessor: Security configuration for IRQ 0. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags.  
...
#[doc = "Security configuration for IRQ 0. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
pub mod seccfg_irq0;
#[doc = "SECCFG_IRQ1 (rw) register accessor: Security configuration for IRQ 1. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags.  
...
#[doc = "Security configuration for IRQ 1. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
pub mod seccfg_irq1;
#[doc = "SECCFG_IRQ2 (rw) register accessor: Security configuration for IRQ 2. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags.  
...
#[doc = "Security configuration for IRQ 2. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags."]
pub mod seccfg_irq2;
#[doc = "SECCFG_IRQ3 (rw) register accessor: Security configuration for IRQ 3. Control whether the IRQ permits configuration by NonSecure/Unprivileged contexts, and whether it can observe Secure/Privileged channel interrupt flags.  
