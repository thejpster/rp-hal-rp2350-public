#[doc = "Register `DBG_POW_STATE_SRAM1` reader"]
pub type R = crate::R<DBG_POW_STATE_SRAM1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`dbg_pow_state_sram1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DBG_POW_STATE_SRAM1_SPEC;
impl crate::RegisterSpec for DBG_POW_STATE_SRAM1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dbg_pow_state_sram1::R`](R) reader structure"]
impl crate::Readable for DBG_POW_STATE_SRAM1_SPEC {}
#[doc = "`reset()` method sets DBG_POW_STATE_SRAM1 to value 0"]
impl crate::Resettable for DBG_POW_STATE_SRAM1_SPEC {
