...
impl RegisterBlock {
    ...
    #[doc = "0x0c - Bus fabric performance counter 0"]
    #[inline(always)]
    pub const fn perfctr0(&self) -> &PERFCTR0 {
        &self.perfctr0
    }
    #[doc = "0x10 - Bus fabric performance event select for PERFCTR0"]
    #[inline(always)]
    pub const fn perfsel0(&self) -> &PERFSEL0 {
        &self.perfsel0
    }
    #[doc = "0x14 - Bus fabric performance counter 1"]
    #[inline(always)]
    pub const fn perfctr1(&self) -> &PERFCTR1 {
        &self.perfctr1
    }
    #[doc = "0x18 - Bus fabric performance event select for PERFCTR1"]
    #[inline(always)]
    pub const fn perfsel1(&self) -> &PERFSEL1 {
        &self.perfsel1
    }
    #[doc = "0x1c - Bus fabric performance counter 2"]
    #[inline(always)]
    pub const fn perfctr2(&self) -> &PERFCTR2 {
        &self.perfctr2
    }
    #[doc = "0x20 - Bus fabric performance event select for PERFCTR2"]
    #[inline(always)]
    pub const fn perfsel2(&self) -> &PERFSEL2 {
        &self.perfsel2
    }
    #[doc = "0x24 - Bus fabric performance counter 3"]
    #[inline(always)]
    pub const fn perfctr3(&self) -> &PERFCTR3 {
        &self.perfctr3
    }
    #[doc = "0x28 - Bus fabric performance event select for PERFCTR3"]
    #[inline(always)]
