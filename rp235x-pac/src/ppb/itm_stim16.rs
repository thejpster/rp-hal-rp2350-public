#[doc = "Register `ITM_STIM16` reader"]
pub type R = crate::R<ITM_STIM16_SPEC>;
#[doc = "Register `ITM_STIM16` writer"]
pub type W = crate::W<ITM_STIM16_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`itm_stim16::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`itm_stim16::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ITM_STIM16_SPEC;
impl crate::RegisterSpec for ITM_STIM16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`itm_stim16::R`](R) reader structure"]
impl crate::Readable for ITM_STIM16_SPEC {}
#[doc = "`write(|w| ..)` method takes [`itm_stim16::W`](W) writer structure"]
impl crate::Writable for ITM_STIM16_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ITM_STIM16 to value 0"]
impl crate::Resettable for ITM_STIM16_SPEC {
