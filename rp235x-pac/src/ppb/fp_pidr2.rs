...
#[doc = "Register `FP_PIDR2` writer"]
pub type W = crate::W<FP_PIDR2_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`fp_pidr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fp_pidr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`fp_pidr2::W`](W) writer structure"]
impl crate::Writable for FP_PIDR2_SPEC {
