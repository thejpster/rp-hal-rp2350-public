...
#[doc = "Register `DDEVTYPE` writer"]
pub type W = crate::W<DDEVTYPE_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ddevtype::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ddevtype::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`ddevtype::W`](W) writer structure"]
impl crate::Writable for DDEVTYPE_SPEC {
