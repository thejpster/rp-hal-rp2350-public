#[doc = "Register `FP_COMP7` reader"]
pub type R = crate::R<FP_COMP7_SPEC>;
#[doc = "Register `FP_COMP7` writer"]
pub type W = crate::W<FP_COMP7_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`fp_comp7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fp_comp7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FP_COMP7_SPEC;
impl crate::RegisterSpec for FP_COMP7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fp_comp7::R`](R) reader structure"]
impl crate::Readable for FP_COMP7_SPEC {}
