...
#[doc = "Register `TRCCIDR3` writer"]
pub type W = crate::W<TRCCIDR3_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`trccidr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`trccidr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`trccidr3::W`](W) writer structure"]
impl crate::Writable for TRCCIDR3_SPEC {
