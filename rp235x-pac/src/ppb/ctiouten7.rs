#[doc = "Register `CTIOUTEN7` reader"]
pub type R = crate::R<CTIOUTEN7_SPEC>;
#[doc = "Register `CTIOUTEN7` writer"]
pub type W = crate::W<CTIOUTEN7_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ctiouten7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctiouten7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CTIOUTEN7_SPEC;
impl crate::RegisterSpec for CTIOUTEN7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctiouten7::R`](R) reader structure"]
impl crate::Readable for CTIOUTEN7_SPEC {}
