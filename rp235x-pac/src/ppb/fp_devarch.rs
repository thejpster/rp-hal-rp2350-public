...
#[doc = "Register `FP_DEVARCH` writer"]
pub type W = crate::W<FP_DEVARCH_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`fp_devarch::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fp_devarch::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`fp_devarch::W`](W) writer structure"]
impl crate::Writable for FP_DEVARCH_SPEC {
