#[doc = "Register `MPU_RLAR_A1` reader"]
pub type R = crate::R<MPU_RLAR_A1_SPEC>;
#[doc = "Register `MPU_RLAR_A1` writer"]
pub type W = crate::W<MPU_RLAR_A1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`mpu_rlar_a1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_rlar_a1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPU_RLAR_A1_SPEC;
impl crate::RegisterSpec for MPU_RLAR_A1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_rlar_a1::R`](R) reader structure"]
impl crate::Readable for MPU_RLAR_A1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mpu_rlar_a1::W`](W) writer structure"]
impl crate::Writable for MPU_RLAR_A1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPU_RLAR_A1 to value 0"]
impl crate::Resettable for MPU_RLAR_A1_SPEC {
