...
#[doc = "Register `DWT_CIDR2` writer"]
pub type W = crate::W<DWT_CIDR2_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`dwt_cidr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dwt_cidr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`dwt_cidr2::W`](W) writer structure"]
impl crate::Writable for DWT_CIDR2_SPEC {
