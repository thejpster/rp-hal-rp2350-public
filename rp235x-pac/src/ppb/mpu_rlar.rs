#[doc = "Register `MPU_RLAR` reader"]
pub type R = crate::R<MPU_RLAR_SPEC>;
#[doc = "Register `MPU_RLAR` writer"]
pub type W = crate::W<MPU_RLAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<MPU_RLAR_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - Associates a set of attributes in the MPU_MAIR0 and MPU_MAIR1 fields"]
    #[inline(always)]
    #[must_use]
    pub fn attrindx(&mut self) -> ATTRINDX_W<MPU_RLAR_SPEC> {
...
of the upper inclusive limit of the selected MPU memory region. This value is postfixed with 0x1F to provide the limit address to be checked against"]
    #[inline(always)]
    #[must_use]
    pub fn limit(&mut self) -> LIMIT_W<MPU_RLAR_SPEC> {
        LIMIT_W::new(self, 5)
    }
}
#[doc = "Provides indirect read and write access to the limit address of the currently selected MPU region `FTSSS  

You can [`read`](crate::Reg::read) this register and get [`mpu_rlar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_rlar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPU_RLAR_SPEC;
impl crate::RegisterSpec for MPU_RLAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_rlar::R`](R) reader structure"]
impl crate::Readable for MPU_RLAR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mpu_rlar::W`](W) writer structure"]
impl crate::Writable for MPU_RLAR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPU_RLAR to value 0"]
impl crate::Resettable for MPU_RLAR_SPEC {
