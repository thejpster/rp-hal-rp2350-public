#[doc = "Register `DWT_FUNCTION0` reader"]
pub type R = crate::R<DWT_FUNCTION0_SPEC>;
#[doc = "Register `DWT_FUNCTION0` writer"]
pub type W = crate::W<DWT_FUNCTION0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn match_(&mut self) -> MATCH_W<DWT_FUNCTION0_SPEC> {
        MATCH_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Defines the action on a match. This field is ignored and the comparator generates no actions if it is disabled by MATCH"]
    #[inline(always)]
    #[must_use]
    pub fn action(&mut self) -> ACTION_W<DWT_FUNCTION0_SPEC> {
        ACTION_W::new(self, 4)
    }
    #[doc = "Bits 10:11 - Defines the size of the object being watched for by Data Value and Data Address comparators"]
    #[inline(always)]
    #[must_use]
    pub fn datavsize(&mut self) -> DATAVSIZE_W<DWT_FUNCTION0_SPEC> {
        DATAVSIZE_W::new(self, 10)
    }
}
#[doc = "Controls the operation of watchpoint comparator 0  

You can [`read`](crate::Reg::read) this register and get [`dwt_function0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dwt_function0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DWT_FUNCTION0_SPEC;
impl crate::RegisterSpec for DWT_FUNCTION0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dwt_function0::R`](R) reader structure"]
impl crate::Readable for DWT_FUNCTION0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`dwt_function0::W`](W) writer structure"]
impl crate::Writable for DWT_FUNCTION0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DWT_FUNCTION0 to value 0x5800_0000"]
impl crate::Resettable for DWT_FUNCTION0_SPEC {
    const RESET_VALUE: u32 = 0x5800_0000;
}
