#[doc = "Register `CTIINEN7` reader"]
pub type R = crate::R<CTIINEN7_SPEC>;
#[doc = "Register `CTIINEN7` writer"]
pub type W = crate::W<CTIINEN7_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ctiinen7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctiinen7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CTIINEN7_SPEC;
impl crate::RegisterSpec for CTIINEN7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctiinen7::R`](R) reader structure"]
impl crate::Readable for CTIINEN7_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ctiinen7::W`](W) writer structure"]
impl crate::Writable for CTIINEN7_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTIINEN7 to value 0"]
impl crate::Resettable for CTIINEN7_SPEC {
