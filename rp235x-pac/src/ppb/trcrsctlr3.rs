#[doc = "Register `TRCRSCTLR3` reader"]
pub type R = crate::R<TRCRSCTLR3_SPEC>;
#[doc = "Register `TRCRSCTLR3` writer"]
pub type W = crate::W<TRCRSCTLR3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn select(&mut self) -> SELECT_W<TRCRSCTLR3_SPEC> {
        SELECT_W::new(self, 0)
    }
    #[doc = "Bits 16:18 - Selects a group of resource"]
    #[inline(always)]
    #[must_use]
    pub fn group(&mut self) -> GROUP_W<TRCRSCTLR3_SPEC> {
        GROUP_W::new(self, 16)
    }
    #[doc = "Bit 20 - Inverts the selected resources"]
    #[inline(always)]
    #[must_use]
    pub fn inv(&mut self) -> INV_W<TRCRSCTLR3_SPEC> {
        INV_W::new(self, 20)
    }
    #[doc = "Bit 21 - Inverts the result of a combined pair of resources. This bit is only implemented on the lower register for a pair of resource selectors"]
    #[inline(always)]
    #[must_use]
    pub fn pairinv(&mut self) -> PAIRINV_W<TRCRSCTLR3_SPEC> {
        PAIRINV_W::new(self, 21)
    }
}
#[doc = "The TRCRSCTLR controls the trace resources  

You can [`read`](crate::Reg::read) this register and get [`trcrsctlr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`trcrsctlr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TRCRSCTLR3_SPEC;
impl crate::RegisterSpec for TRCRSCTLR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trcrsctlr3::R`](R) reader structure"]
impl crate::Readable for TRCRSCTLR3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`trcrsctlr3::W`](W) writer structure"]
impl crate::Writable for TRCRSCTLR3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TRCRSCTLR3 to value 0"]
impl crate::Resettable for TRCRSCTLR3_SPEC {
