...
#[doc = "Field `DPIDR6` reader - "]
pub type DPIDR6_R = crate::FieldReader<u32>;
#[doc = "Field `DPIDR6` writer - "]
pub type DPIDR6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dpidr6(&self) -> DPIDR6_R {
        DPIDR6_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    #[must_use]
    pub fn dpidr6(&mut self) -> DPIDR6_W<DPIDR6_SPEC> {
        DPIDR6_W::new(self, 0)
    }
}
