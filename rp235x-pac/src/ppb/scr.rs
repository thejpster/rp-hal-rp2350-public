...
#[doc = "Field `SLEEPDEEPS` reader - 0 SLEEPDEEP is available to both security states 1 SLEEPDEEP is only available to Secure state"]
pub type SLEEPDEEPS_R = crate::BitReader;
#[doc = "Field `SLEEPDEEPS` writer - 0 SLEEPDEEP is available to both security states 1 SLEEPDEEP is only available to Secure state"]
pub type SLEEPDEEPS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 3 - 0 SLEEPDEEP is available to both security states 1 SLEEPDEEP is only available to Secure state"]
    #[inline(always)]
