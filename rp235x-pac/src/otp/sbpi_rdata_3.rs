...
#[doc = "Register `SBPI_RDATA_3` writer"]
pub type W = crate::W<SBPI_RDATA_3_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`sbpi_rdata_3::W`](W) writer structure"]
impl crate::Writable for SBPI_RDATA_3_SPEC {
