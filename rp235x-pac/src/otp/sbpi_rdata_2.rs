...
impl core::fmt::Debug for crate::generic::Reg<SBPI_RDATA_2_SPEC> {
...
You can [`read`](crate::Reg::read) this register and get [`sbpi_rdata_2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api).  
