...
impl crate::RegisterSpec for SW_LOCK20_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sw_lock20::R`](R) reader structure"]
impl crate::Readable for SW_LOCK20_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sw_lock20::W`](W) writer structure"]
impl crate::Writable for SW_LOCK20_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SW_LOCK20 to value 0"]
impl crate::Resettable for SW_LOCK20_SPEC {
