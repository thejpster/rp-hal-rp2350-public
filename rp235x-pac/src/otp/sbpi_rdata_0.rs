...
#[doc = "Register `SBPI_RDATA_0` writer"]
pub type W = crate::W<SBPI_RDATA_0_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`sbpi_rdata_0::W`](W) writer structure"]
impl crate::Writable for SBPI_RDATA_0_SPEC {
