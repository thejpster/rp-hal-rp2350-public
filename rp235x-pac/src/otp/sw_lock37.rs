#[doc = "Register `SW_LOCK37` reader"]
pub type R = crate::R<SW_LOCK37_SPEC>;
#[doc = "Register `SW_LOCK37` writer"]
pub type W = crate::W<SW_LOCK37_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SEC_W<SW_LOCK37_SPEC> {
        SEC_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Non-secure lock status. Writes are OR'd with the current value."]
    #[inline(always)]
    #[must_use]
    pub fn nsec(&mut self) -> NSEC_W<SW_LOCK37_SPEC> {
        NSEC_W::new(self, 2)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`sw_lock37::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sw_lock37::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SW_LOCK37_SPEC;
impl crate::RegisterSpec for SW_LOCK37_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sw_lock37::R`](R) reader structure"]
impl crate::Readable for SW_LOCK37_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sw_lock37::W`](W) writer structure"]
impl crate::Writable for SW_LOCK37_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SW_LOCK37 to value 0"]
impl crate::Resettable for SW_LOCK37_SPEC {
