#[doc = "Register `SW_LOCK9` reader"]
pub type R = crate::R<SW_LOCK9_SPEC>;
#[doc = "Register `SW_LOCK9` writer"]
pub type W = crate::W<SW_LOCK9_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`sw_lock9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sw_lock9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SW_LOCK9_SPEC;
impl crate::RegisterSpec for SW_LOCK9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sw_lock9::R`](R) reader structure"]
impl crate::Readable for SW_LOCK9_SPEC {}
