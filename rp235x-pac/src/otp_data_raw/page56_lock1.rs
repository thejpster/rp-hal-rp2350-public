...
#[doc = "Register `PAGE56_LOCK1` writer"]
pub type W = crate::W<PAGE56_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page56_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE56_LOCK1_SPEC {
