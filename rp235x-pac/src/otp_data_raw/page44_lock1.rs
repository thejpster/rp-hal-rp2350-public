...
#[doc = "Register `PAGE44_LOCK1` writer"]
pub type W = crate::W<PAGE44_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page44_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE44_LOCK1_SPEC {
