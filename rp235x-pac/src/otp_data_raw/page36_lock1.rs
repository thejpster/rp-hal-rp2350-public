...
#[doc = "Register `PAGE36_LOCK1` writer"]
pub type W = crate::W<PAGE36_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page36_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE36_LOCK1_SPEC {
