...
#[doc = "Register `PAGE61_LOCK1` writer"]
pub type W = crate::W<PAGE61_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page61_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE61_LOCK1_SPEC {
