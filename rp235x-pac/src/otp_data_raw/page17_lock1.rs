...
#[doc = "Register `PAGE17_LOCK1` writer"]
pub type W = crate::W<PAGE17_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page17_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE17_LOCK1_SPEC {
