...
#[doc = "Register `PAGE1_LOCK1` writer"]
pub type W = crate::W<PAGE1_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page1_lock1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`page1_lock1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`page1_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE1_LOCK1_SPEC {
