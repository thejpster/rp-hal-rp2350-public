...
#[doc = "Register `PAGE59_LOCK1` writer"]
pub type W = crate::W<PAGE59_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page59_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE59_LOCK1_SPEC {
