...
#[doc = "Register `PAGE52_LOCK1` writer"]
pub type W = crate::W<PAGE52_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page52_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE52_LOCK1_SPEC {
