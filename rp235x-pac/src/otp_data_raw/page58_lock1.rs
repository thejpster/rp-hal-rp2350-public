...
#[doc = "Register `PAGE58_LOCK1` writer"]
pub type W = crate::W<PAGE58_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page58_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE58_LOCK1_SPEC {
