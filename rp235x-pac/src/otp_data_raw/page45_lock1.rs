...
#[doc = "Register `PAGE45_LOCK1` writer"]
pub type W = crate::W<PAGE45_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page45_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE45_LOCK1_SPEC {
