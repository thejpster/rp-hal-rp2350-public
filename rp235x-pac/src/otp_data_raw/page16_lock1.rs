...
#[doc = "Register `PAGE16_LOCK1` writer"]
pub type W = crate::W<PAGE16_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page16_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE16_LOCK1_SPEC {
