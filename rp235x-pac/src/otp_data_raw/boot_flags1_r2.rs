...
#[doc = "Register `BOOT_FLAGS1_R2` writer"]
pub type W = crate::W<BOOT_FLAGS1_R2_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`boot_flags1_r2::W`](W) writer structure"]
impl crate::Writable for BOOT_FLAGS1_R2_SPEC {
