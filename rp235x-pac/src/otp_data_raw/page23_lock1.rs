...
#[doc = "Register `PAGE23_LOCK1` writer"]
pub type W = crate::W<PAGE23_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page23_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE23_LOCK1_SPEC {
