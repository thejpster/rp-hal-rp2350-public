...
#[doc = "Register `PAGE55_LOCK1` writer"]
pub type W = crate::W<PAGE55_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page55_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE55_LOCK1_SPEC {
