...
#[doc = "Register `PAGE25_LOCK1` writer"]
pub type W = crate::W<PAGE25_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page25_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE25_LOCK1_SPEC {
