...
#[doc = "Register `PAGE30_LOCK1` writer"]
pub type W = crate::W<PAGE30_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page30_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE30_LOCK1_SPEC {
