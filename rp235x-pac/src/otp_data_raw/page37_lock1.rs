...
#[doc = "Register `PAGE37_LOCK1` writer"]
pub type W = crate::W<PAGE37_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page37_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE37_LOCK1_SPEC {
