#[doc = "Register `PAGE22_LOCK0` reader"]
pub type R = crate::R<PAGE22_LOCK0_SPEC>;
#[doc = "Register `PAGE22_LOCK0` writer"]
pub type W = crate::W<PAGE22_LOCK0_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page22_lock0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`page22_lock0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE22_LOCK0_SPEC;
impl crate::RegisterSpec for PAGE22_LOCK0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page22_lock0::R`](R) reader structure"]
impl crate::Readable for PAGE22_LOCK0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`page22_lock0::W`](W) writer structure"]
impl crate::Writable for PAGE22_LOCK0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAGE22_LOCK0 to value 0"]
impl crate::Resettable for PAGE22_LOCK0_SPEC {
