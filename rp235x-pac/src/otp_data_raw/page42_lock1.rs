...
#[doc = "Register `PAGE42_LOCK1` writer"]
pub type W = crate::W<PAGE42_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page42_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE42_LOCK1_SPEC {
