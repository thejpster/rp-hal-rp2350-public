...
#[doc = "Register `PAGE18_LOCK1` writer"]
pub type W = crate::W<PAGE18_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page18_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE18_LOCK1_SPEC {
