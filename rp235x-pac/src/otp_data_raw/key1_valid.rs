#[doc = "Register `KEY1_VALID` reader"]
pub type R = crate::R<KEY1_VALID_SPEC>;
#[doc = "Register `KEY1_VALID` writer"]
pub type W = crate::W<KEY1_VALID_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`key1_valid::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`key1_valid::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct KEY1_VALID_SPEC;
impl crate::RegisterSpec for KEY1_VALID_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`key1_valid::R`](R) reader structure"]
impl crate::Readable for KEY1_VALID_SPEC {}
#[doc = "`write(|w| ..)` method takes [`key1_valid::W`](W) writer structure"]
impl crate::Writable for KEY1_VALID_SPEC {
