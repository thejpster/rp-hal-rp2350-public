...
#[doc = "Register `PAGE39_LOCK1` writer"]
pub type W = crate::W<PAGE39_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page39_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE39_LOCK1_SPEC {
