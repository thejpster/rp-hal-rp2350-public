...
#[doc = "Register `DEFAULT_BOOT_VERSION0_R1` writer"]
pub type W = crate::W<DEFAULT_BOOT_VERSION0_R1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`default_boot_version0_r1::W`](W) writer structure"]
impl crate::Writable for DEFAULT_BOOT_VERSION0_R1_SPEC {
