...
#[doc = "Register `PAGE50_LOCK1` writer"]
pub type W = crate::W<PAGE50_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page50_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE50_LOCK1_SPEC {
