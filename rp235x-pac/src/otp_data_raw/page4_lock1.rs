...
#[doc = "Register `PAGE4_LOCK1` writer"]
pub type W = crate::W<PAGE4_LOCK1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`page4_lock1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`page4_lock1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`page4_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE4_LOCK1_SPEC {
