#[doc = "Register `PAGE63_LOCK0` reader"]
pub type R = crate::R<PAGE63_LOCK0_SPEC>;
#[doc = "Register `PAGE63_LOCK0` writer"]
pub type W = crate::W<PAGE63_LOCK0_SPEC>;
...
#[doc = "Field `RMA` reader - Decommission for RMA of a suspected faulty device. This re-enables the factory test JTAG interface, and makes pages 3 through 61 of the OTP permanently inaccessible."]
pub type RMA_R = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 7 - Decommission for RMA of a suspected faulty device. This re-enables the factory test JTAG interface, and makes pages 3 through 61 of the OTP permanently inaccessible."]
    #[inline(always)]
    pub fn rma(&self) -> RMA_R {
        RMA_R::new(((self.bits >> 7) & 1) != 0)
    }
...
You can [`read`](crate::Reg::read) this register and get [`page63_lock0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`page63_lock0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAGE63_LOCK0_SPEC;
impl crate::RegisterSpec for PAGE63_LOCK0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`page63_lock0::R`](R) reader structure"]
impl crate::Readable for PAGE63_LOCK0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`page63_lock0::W`](W) writer structure"]
impl crate::Writable for PAGE63_LOCK0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PAGE63_LOCK0 to value 0"]
impl crate::Resettable for PAGE63_LOCK0_SPEC {
