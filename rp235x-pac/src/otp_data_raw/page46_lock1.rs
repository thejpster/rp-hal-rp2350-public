...
#[doc = "Register `PAGE46_LOCK1` writer"]
pub type W = crate::W<PAGE46_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page46_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE46_LOCK1_SPEC {
