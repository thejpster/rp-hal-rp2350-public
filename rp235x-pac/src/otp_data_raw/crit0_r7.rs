...
#[doc = "Register `CRIT0_R7` writer"]
pub type W = crate::W<CRIT0_R7_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`crit0_r7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crit0_r7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`crit0_r7::W`](W) writer structure"]
impl crate::Writable for CRIT0_R7_SPEC {
