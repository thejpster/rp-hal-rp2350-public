...
#[doc = "Register `PAGE32_LOCK1` writer"]
pub type W = crate::W<PAGE32_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page32_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE32_LOCK1_SPEC {
