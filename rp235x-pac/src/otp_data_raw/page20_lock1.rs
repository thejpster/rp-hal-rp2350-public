...
#[doc = "Register `PAGE20_LOCK1` writer"]
pub type W = crate::W<PAGE20_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page20_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE20_LOCK1_SPEC {
