...
#[doc = "Register `DEFAULT_BOOT_VERSION0_R2` writer"]
pub type W = crate::W<DEFAULT_BOOT_VERSION0_R2_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`default_boot_version0_r2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`default_boot_version0_r2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`default_boot_version0_r2::W`](W) writer structure"]
impl crate::Writable for DEFAULT_BOOT_VERSION0_R2_SPEC {
