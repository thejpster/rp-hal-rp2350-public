...
#[doc = "Register `CRIT1_R1` writer"]
pub type W = crate::W<CRIT1_R1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`crit1_r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crit1_r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`crit1_r1::W`](W) writer structure"]
impl crate::Writable for CRIT1_R1_SPEC {
