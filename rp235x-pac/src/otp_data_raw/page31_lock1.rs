...
#[doc = "Register `PAGE31_LOCK1` writer"]
pub type W = crate::W<PAGE31_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page31_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE31_LOCK1_SPEC {
