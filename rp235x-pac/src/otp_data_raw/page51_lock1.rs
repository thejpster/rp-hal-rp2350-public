...
#[doc = "Register `PAGE51_LOCK1` writer"]
pub type W = crate::W<PAGE51_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page51_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE51_LOCK1_SPEC {
