...
#[doc = "Register `BOOT_FLAGS1_R1` writer"]
pub type W = crate::W<BOOT_FLAGS1_R1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`boot_flags1_r1::W`](W) writer structure"]
impl crate::Writable for BOOT_FLAGS1_R1_SPEC {
