...
#[doc = "Register `PAGE22_LOCK1` writer"]
pub type W = crate::W<PAGE22_LOCK1_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`page22_lock1::W`](W) writer structure"]
impl crate::Writable for PAGE22_LOCK1_SPEC {
