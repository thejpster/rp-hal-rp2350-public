...
#[doc = "Field `INTE2` reader - Set bit n to pass interrupts from channel n to DMA IRQ 2.  
...
#[doc = "Field `INTE2` writer - Set bit n to pass interrupts from channel n to DMA IRQ 2.  

 Note this bit has no effect if the channel security/privilege level, defined by SECCFG_CHx, is greater than the IRQ security/privilege defined by SECCFG_IRQ2."]
pub type INTE2_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Set bit n to pass interrupts from channel n to DMA IRQ 2.  
