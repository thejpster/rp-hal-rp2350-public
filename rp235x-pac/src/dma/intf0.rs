...
#[doc = "Field `INTF0` reader - Write 1s to force the corresponding bits in INTS0. The interrupt remains asserted until INTF0 is cleared."]
pub type INTF0_R = crate::FieldReader<u16>;
#[doc = "Field `INTF0` writer - Write 1s to force the corresponding bits in INTS0. The interrupt remains asserted until INTF0 is cleared."]
