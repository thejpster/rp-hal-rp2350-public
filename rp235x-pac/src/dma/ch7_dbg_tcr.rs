...
#[doc = "Register `CH7_DBG_TCR` writer"]
pub type W = crate::W<CH7_DBG_TCR_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ch7_dbg_tcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch7_dbg_tcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`ch7_dbg_tcr::W`](W) writer structure"]
impl crate::Writable for CH7_DBG_TCR_SPEC {
