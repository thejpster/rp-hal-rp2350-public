#[doc = "Register `MPU_LAR0` reader"]
pub type R = crate::R<MPU_LAR0_SPEC>;
#[doc = "Register `MPU_LAR0` writer"]
pub type W = crate::W<MPU_LAR0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<MPU_LAR0_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Determines the Privileged/Unprivileged (=1/0) status of addresses matching this region, if this region is enabled. Writable from any Privileged context, if and only if the S bit is clear. Otherwise, writable only from a Secure, Privileged context."]
    #[inline(always)]
    #[must_use]
    pub fn p(&mut self) -> P_W<MPU_LAR0_SPEC> {
        P_W::new(self, 1)
    }
    #[doc = "Bit 2 - Determines the Secure/NonSecure (=1/0) status of addresses matching this region, if this region is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<MPU_LAR0_SPEC> {
        S_W::new(self, 2)
    }
    #[doc = "Bits 5:31 - Limit address bits 31:5. Readable from any Privileged context, if and only if this region's S bit is clear, and MPU_CTRL_NS_HIDE_ADDR is clear. Otherwise readable only from a Secure, Privileged context."]
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<MPU_LAR0_SPEC> {
        ADDR_W::new(self, 5)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`mpu_lar0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mpu_lar0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MPU_LAR0_SPEC;
impl crate::RegisterSpec for MPU_LAR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_lar0::R`](R) reader structure"]
impl crate::Readable for MPU_LAR0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mpu_lar0::W`](W) writer structure"]
impl crate::Writable for MPU_LAR0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPU_LAR0 to value 0"]
impl crate::Resettable for MPU_LAR0_SPEC {
