#[doc = "Register `SECCFG_IRQ3` reader"]
...
impl crate::RegisterSpec for SECCFG_IRQ3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`seccfg_irq3::R`](R) reader structure"]
impl crate::Readable for SECCFG_IRQ3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`seccfg_irq3::W`](W) writer structure"]
impl crate::Writable for SECCFG_IRQ3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SECCFG_IRQ3 to value 0x03"]
impl crate::Resettable for SECCFG_IRQ3_SPEC {
