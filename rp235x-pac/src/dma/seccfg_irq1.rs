#[doc = "Register `SECCFG_IRQ1` reader"]
pub type R = crate::R<SECCFG_IRQ1_SPEC>;
#[doc = "Register `SECCFG_IRQ1` writer"]
pub type W = crate::W<SECCFG_IRQ1_SPEC>;
...
impl W {
 ...
 If 0, this IRQ's control registers can be accessed from an Unprivileged context, but Privileged channels (as per SECCFG_CHx) are masked from the IRQ status, and this IRQ's registers can not be used to acknowledge the channel interrupts of Privileged channels."]
    #[inline(always)]
    #[must_use]
    pub fn p(&mut self) -> P_W<SECCFG_IRQ1_SPEC> {
        P_W::new(self, 0)
    }
    #[doc = "Bit 1 - Secure IRQ. If 1, this IRQ's control registers can only be accessed from a Secure context.  
 ...
 If 0, this IRQ's control registers can be accessed from a NonSecure context, but Secure channels (as per SECCFG_CHx) are masked from the IRQ status, and this IRQ's registers can not be used to acknowledge the channel interrupts of Secure channels."]
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<SECCFG_IRQ1_SPEC> {
        S_W::new(self, 1)
    }
}
...
You can [`read`](crate::Reg::read) this register and get [`seccfg_irq1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`seccfg_irq1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SECCFG_IRQ1_SPEC;
impl crate::RegisterSpec for SECCFG_IRQ1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`seccfg_irq1::R`](R) reader structure"]
impl crate::Readable for SECCFG_IRQ1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`seccfg_irq1::W`](W) writer structure"]
impl crate::Writable for SECCFG_IRQ1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SECCFG_IRQ1 to value 0x03"]
impl crate::Resettable for SECCFG_IRQ1_SPEC {
