...
#[doc = "Field `CH0_AL3_READ_ADDR_TRIG` reader - "]
pub type CH0_AL3_READ_ADDR_TRIG_R = crate::FieldReader<u32>;
#[doc = "Field `CH0_AL3_READ_ADDR_TRIG` writer - "]
pub type CH0_AL3_READ_ADDR_TRIG_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ch0_al3_read_addr_trig(&self) -> CH0_AL3_READ_ADDR_TRIG_R {
        CH0_AL3_READ_ADDR_TRIG_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    ...
    pub fn ch0_al3_read_addr_trig(
        &mut self,
    ) -> CH0_AL3_READ_ADDR_TRIG_W<CH_AL3_READ_ADDR_TRIG_SPEC> {
        CH0_AL3_READ_ADDR_TRIG_W::new(self, 0)
    }
}
