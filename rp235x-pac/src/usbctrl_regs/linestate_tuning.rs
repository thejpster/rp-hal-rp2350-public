...
#[doc = "Field `DEV_BUFF_CONTROL_DOUBLE_READ_FIX` reader - Device - the controller FSM performs two reads of the buffer status memory address to  
...
#[doc = "Field `DEV_BUFF_CONTROL_DOUBLE_READ_FIX` writer - Device - the controller FSM performs two reads of the buffer status memory address to  
 avoid sampling metastable data. An enabled buffer is only used if both reads match."]
pub type DEV_BUFF_CONTROL_DOUBLE_READ_FIX_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SIE_RX_BITSTUFF_FIX` reader - RX - when a bitstuff error is signalled by rx_dasm, unconditionally terminate RX decode to  
 avoid a hang during certain packet phases."]
pub type SIE_RX_BITSTUFF_FIX_R = crate::BitReader;
#[doc = "Field `SIE_RX_BITSTUFF_FIX` writer - RX - when a bitstuff error is signalled by rx_dasm, unconditionally terminate RX decode to  
 avoid a hang during certain packet phases."]
pub type SIE_RX_BITSTUFF_FIX_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SIE_RX_CHATTER_SE0_FIX` reader - RX - when recovering from line chatter or bitstuff errors, treat SE0 as the end of chatter as well as  
 8 consecutive idle bits."]
pub type SIE_RX_CHATTER_SE0_FIX_R = crate::BitReader;
#[doc = "Field `SIE_RX_CHATTER_SE0_FIX` writer - RX - when recovering from line chatter or bitstuff errors, treat SE0 as the end of chatter as well as  
 8 consecutive idle bits."]
...
impl R {
    ...
    #[doc = "Bit 3 - Device - the controller FSM performs two reads of the buffer status memory address to  
 avoid sampling metastable data. An enabled buffer is only used if both reads match."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - RX - when a bitstuff error is signalled by rx_dasm, unconditionally terminate RX decode to  
 avoid a hang during certain packet phases."]
    #[inline(always)]
    pub fn sie_rx_bitstuff_fix(&self) -> SIE_RX_BITSTUFF_FIX_R {
        SIE_RX_BITSTUFF_FIX_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - RX - when recovering from line chatter or bitstuff errors, treat SE0 as the end of chatter as well as  
 8 consecutive idle bits."]
    #[inline(always)]
