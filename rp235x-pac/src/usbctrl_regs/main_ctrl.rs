...
#[doc = "Field `PHY_ISO` reader - Isolates USB phy after controller power-up  
 Remove isolation once software has configured the controller  
 Not isolated = 0, Isolated = 1"]
pub type PHY_ISO_R = crate::BitReader;
#[doc = "Field `PHY_ISO` writer - Isolates USB phy after controller power-up  
 Remove isolation once software has configured the controller  
 Not isolated = 0, Isolated = 1"]
...
impl R {
    ...
    #[doc = "Bit 2 - Isolates USB phy after controller power-up  
 Remove isolation once software has configured the controller  
 Not isolated = 0, Isolated = 1"]
    #[inline(always)]
