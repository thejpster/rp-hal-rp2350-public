...
#[doc = "Field `EN` reader - Enable direct mode.  
...
#[doc = "Field `EN` writer - Enable direct mode.  

 In direct mode, software controls the chip select lines, and can perform direct SPI transfers by pushing data to the DIRECT_TX FIFO, and popping the same amount of data from the DIRECT_RX FIFO.  

 Memory-mapped accesses will generate bus errors when direct serial mode is enabled."]
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BUSY` reader - Direct mode busy flag. If 1, data is currently being shifted in/out (or would be if the interface were not stalled on the RX FIFO), and the chip select must not yet be deasserted.  
...
#[doc = "Field `ASSERT_CS0N` reader - When 1, assert (i.e. drive low) the CS0n chip select line.  

 Note that this applies even when DIRECT_CSR_EN is 0."]
pub type ASSERT_CS0N_R = crate::BitReader;
#[doc = "Field `ASSERT_CS0N` writer - When 1, assert (i.e. drive low) the CS0n chip select line.  

 Note that this applies even when DIRECT_CSR_EN is 0."]
pub type ASSERT_CS0N_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASSERT_CS1N` reader - When 1, assert (i.e. drive low) the CS1n chip select line.  

 Note that this applies even when DIRECT_CSR_EN is 0."]
pub type ASSERT_CS1N_R = crate::BitReader;
#[doc = "Field `ASSERT_CS1N` writer - When 1, assert (i.e. drive low) the CS1n chip select line.  
...
#[doc = "Field `CLKDIV` reader - Clock divisor for direct serial mode. Divisors of 1..255 are encoded directly, and the maximum divisor of 256 is encoded by a value of CLKDIV=0.  
...
#[doc = "Field `CLKDIV` writer - Clock divisor for direct serial mode. Divisors of 1..255 are encoded directly, and the maximum divisor of 256 is encoded by a value of CLKDIV=0.  
...
impl R {
 ...
 Memory-mapped accesses will generate bus errors when direct serial mode is enabled."]
    ...
    #[doc = "Bit 1 - Direct mode busy flag. If 1, data is currently being shifted in/out (or would be if the interface were not stalled on the RX FIFO), and the chip select must not yet be deasserted.  
 ...
 (In practice you will usually discover this timing condition through other means, because any subsequent memory-mapped transfers when direct mode is enabled will return bus errors, which are difficult to ignore.)"]
    ...
    #[doc = "Bit 2 - When 1, assert (i.e. drive low) the CS0n chip select line.  
 ...
 Note that this applies even when DIRECT_CSR_EN is 0."]
    ...
    #[doc = "Bit 3 - When 1, assert (i.e. drive low) the CS1n chip select line.  
 ...
 Note that this applies even when DIRECT_CSR_EN is 0."]
    ...
    #[doc = "Bits 22:29 - Clock divisor for direct serial mode. Divisors of 1..255 are encoded directly, and the maximum divisor of 256 is encoded by a value of CLKDIV=0.  
