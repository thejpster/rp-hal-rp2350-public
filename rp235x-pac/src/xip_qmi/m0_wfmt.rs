#[doc = "Register `M0_WFMT` reader"]
pub type R = crate::R<M0_WFMT_SPEC>;
#[doc = "Register `M0_WFMT` writer"]
pub type W = crate::W<M0_WFMT_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`m0_wfmt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m0_wfmt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct M0_WFMT_SPEC;
impl crate::RegisterSpec for M0_WFMT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`m0_wfmt::R`](R) reader structure"]
impl crate::Readable for M0_WFMT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`m0_wfmt::W`](W) writer structure"]
impl crate::Writable for M0_WFMT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets M0_WFMT to value 0x1000"]
impl crate::Resettable for M0_WFMT_SPEC {
