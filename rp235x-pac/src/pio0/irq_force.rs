#[doc = "Register `IRQ_FORCE` reader"]
pub type R = crate::R<IRQ_FORCE_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`irq_force::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`irq_force::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IRQ_FORCE_SPEC;
impl crate::RegisterSpec for IRQ_FORCE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irq_force::R`](R) reader structure"]
impl crate::Readable for IRQ_FORCE_SPEC {}
