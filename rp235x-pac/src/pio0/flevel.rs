...
#[doc = "Register `FLEVEL` writer"]
pub type W = crate::W<FLEVEL_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`flevel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flevel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`flevel::W`](W) writer structure"]
impl crate::Writable for FLEVEL_SPEC {
