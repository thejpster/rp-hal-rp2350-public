...
impl PERFSEL0_R {
    ...
    pub const fn variant(&self) -> Option<PERFSEL0_A> {
        match self.bits {
            0 => Some(PERFSEL0_A::SIOB_PROC1_STALL_UPSTREAM),
            1 => Some(PERFSEL0_A::SIOB_PROC1_STALL_DOWNSTREAM),
            2 => Some(PERFSEL0_A::SIOB_PROC1_ACCESS_CONTESTED),
            3 => Some(PERFSEL0_A::SIOB_PROC1_ACCESS),
            4 => Some(PERFSEL0_A::SIOB_PROC0_STALL_UPSTREAM),
            5 => Some(PERFSEL0_A::SIOB_PROC0_STALL_DOWNSTREAM),
            6 => Some(PERFSEL0_A::SIOB_PROC0_ACCESS_CONTESTED),
            7 => Some(PERFSEL0_A::SIOB_PROC0_ACCESS),
            8 => Some(PERFSEL0_A::APB_STALL_UPSTREAM),
            9 => Some(PERFSEL0_A::APB_STALL_DOWNSTREAM),
            10 => Some(PERFSEL0_A::APB_ACCESS_CONTESTED),
            11 => Some(PERFSEL0_A::APB_ACCESS),
            12 => Some(PERFSEL0_A::FASTPERI_STALL_UPSTREAM),
            13 => Some(PERFSEL0_A::FASTPERI_STALL_DOWNSTREAM),
            14 => Some(PERFSEL0_A::FASTPERI_ACCESS_CONTESTED),
            15 => Some(PERFSEL0_A::FASTPERI_ACCESS),
            16 => Some(PERFSEL0_A::SRAM9_STALL_UPSTREAM),
            17 => Some(PERFSEL0_A::SRAM9_STALL_DOWNSTREAM),
            18 => Some(PERFSEL0_A::SRAM9_ACCESS_CONTESTED),
            19 => Some(PERFSEL0_A::SRAM9_ACCESS),
            20 => Some(PERFSEL0_A::SRAM8_STALL_UPSTREAM),
            21 => Some(PERFSEL0_A::SRAM8_STALL_DOWNSTREAM),
            22 => Some(PERFSEL0_A::SRAM8_ACCESS_CONTESTED),
            23 => Some(PERFSEL0_A::SRAM8_ACCESS),
            24 => Some(PERFSEL0_A::SRAM7_STALL_UPSTREAM),
            25 => Some(PERFSEL0_A::SRAM7_STALL_DOWNSTREAM),
            26 => Some(PERFSEL0_A::SRAM7_ACCESS_CONTESTED),
            27 => Some(PERFSEL0_A::SRAM7_ACCESS),
            28 => Some(PERFSEL0_A::SRAM6_STALL_UPSTREAM),
            29 => Some(PERFSEL0_A::SRAM6_STALL_DOWNSTREAM),
            30 => Some(PERFSEL0_A::SRAM6_ACCESS_CONTESTED),
            31 => Some(PERFSEL0_A::SRAM6_ACCESS),
            32 => Some(PERFSEL0_A::SRAM5_STALL_UPSTREAM),
            33 => Some(PERFSEL0_A::SRAM5_STALL_DOWNSTREAM),
            34 => Some(PERFSEL0_A::SRAM5_ACCESS_CONTESTED),
            35 => Some(PERFSEL0_A::SRAM5_ACCESS),
            36 => Some(PERFSEL0_A::SRAM4_STALL_UPSTREAM),
            37 => Some(PERFSEL0_A::SRAM4_STALL_DOWNSTREAM),
            38 => Some(PERFSEL0_A::SRAM4_ACCESS_CONTESTED),
            39 => Some(PERFSEL0_A::SRAM4_ACCESS),
            40 => Some(PERFSEL0_A::SRAM3_STALL_UPSTREAM),
            41 => Some(PERFSEL0_A::SRAM3_STALL_DOWNSTREAM),
            42 => Some(PERFSEL0_A::SRAM3_ACCESS_CONTESTED),
            43 => Some(PERFSEL0_A::SRAM3_ACCESS),
            44 => Some(PERFSEL0_A::SRAM2_STALL_UPSTREAM),
            45 => Some(PERFSEL0_A::SRAM2_STALL_DOWNSTREAM),
            46 => Some(PERFSEL0_A::SRAM2_ACCESS_CONTESTED),
            47 => Some(PERFSEL0_A::SRAM2_ACCESS),
            48 => Some(PERFSEL0_A::SRAM1_STALL_UPSTREAM),
            49 => Some(PERFSEL0_A::SRAM1_STALL_DOWNSTREAM),
            50 => Some(PERFSEL0_A::SRAM1_ACCESS_CONTESTED),
            51 => Some(PERFSEL0_A::SRAM1_ACCESS),
            52 => Some(PERFSEL0_A::SRAM0_STALL_UPSTREAM),
            53 => Some(PERFSEL0_A::SRAM0_STALL_DOWNSTREAM),
            54 => Some(PERFSEL0_A::SRAM0_ACCESS_CONTESTED),
            55 => Some(PERFSEL0_A::SRAM0_ACCESS),
            56 => Some(PERFSEL0_A::XIP_MAIN1_STALL_UPSTREAM),
            57 => Some(PERFSEL0_A::XIP_MAIN1_STALL_DOWNSTREAM),
            58 => Some(PERFSEL0_A::XIP_MAIN1_ACCESS_CONTESTED),
            59 => Some(PERFSEL0_A::XIP_MAIN1_ACCESS),
            60 => Some(PERFSEL0_A::XIP_MAIN0_STALL_UPSTREAM),
            61 => Some(PERFSEL0_A::XIP_MAIN0_STALL_DOWNSTREAM),
            62 => Some(PERFSEL0_A::XIP_MAIN0_ACCESS_CONTESTED),
            63 => Some(PERFSEL0_A::XIP_MAIN0_ACCESS),
            64 => Some(PERFSEL0_A::ROM_STALL_UPSTREAM),
            65 => Some(PERFSEL0_A::ROM_STALL_DOWNSTREAM),
            66 => Some(PERFSEL0_A::ROM_ACCESS_CONTESTED),
            67 => Some(PERFSEL0_A::ROM_ACCESS),
            _ => None,
        }
    }
    #[doc = "`0`"]
...
impl R {
    ...
    pub fn perfsel0(&self) -> PERFSEL0_R {
        PERFSEL0_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Select an event for PERFCTR0. For each downstream port of the main crossbar, four events are available: ACCESS, an access took place; ACCESS_CONTESTED, an access took place that previously stalled due to contention from other masters; STALL_DOWNSTREAM, count cycles where any master stalled due to a stall on the downstream bus; STALL_UPSTREAM, count cycles where any master stalled for any reason, including contention from other masters."]
