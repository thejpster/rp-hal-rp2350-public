...
impl RegisterBlock {
    #[doc = "0x00 - Cache control register. Read-only from a Non-secure context."]
    #[inline(always)]
...
#[doc = "CTRL (rw) register accessor: Cache control register. Read-only from a Non-secure context.  
...
You can [`read`](crate::Reg::read) this register and get [`stream_fifo::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`stream_fifo::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  
