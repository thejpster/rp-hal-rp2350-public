...
impl RegisterBlock {
    #[doc = "0x00 - Cache control register. Read-only from a NonSecure context."]
    #[inline(always)]
...
#[doc = "CTRL (rw) register accessor: Cache control register. Read-only from a NonSecure context.  
