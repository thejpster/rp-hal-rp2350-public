...
#[doc = "Field `LOCK_N` reader - PLL is not locked Ideally this is cleared when PLL lock is seen and this should never normally be set"]
pub type LOCK_N_R = crate::BitReader;
#[doc = "Field `LOCK_N` writer - PLL is not locked Ideally this is cleared when PLL lock is seen and this should never normally be set"]
pub type LOCK_N_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 30 - PLL is not locked Ideally this is cleared when PLL lock is seen and this should never normally be set"]
    #[inline(always)]
    pub fn lock_n(&self) -> LOCK_N_R {
        LOCK_N_R::new(((self.bits >> 30) & 1) != 0)
    }
