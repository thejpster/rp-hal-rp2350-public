#[doc = "Register `IRQ0_INTE` reader"]
pub type R = crate::R<IRQ0_INTE_SPEC>;
#[doc = "Register `IRQ0_INTE` writer"]
pub type W = crate::W<IRQ0_INTE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> CH0_W<IRQ0_INTE_SPEC> {
        CH0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> CH1_W<IRQ0_INTE_SPEC> {
        CH1_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> CH2_W<IRQ0_INTE_SPEC> {
        CH2_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> CH3_W<IRQ0_INTE_SPEC> {
        CH3_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<IRQ0_INTE_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> CH5_W<IRQ0_INTE_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> CH6_W<IRQ0_INTE_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> CH7_W<IRQ0_INTE_SPEC> {
        CH7_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn ch8(&mut self) -> CH8_W<IRQ0_INTE_SPEC> {
        CH8_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn ch9(&mut self) -> CH9_W<IRQ0_INTE_SPEC> {
        CH9_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn ch10(&mut self) -> CH10_W<IRQ0_INTE_SPEC> {
        CH10_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn ch11(&mut self) -> CH11_W<IRQ0_INTE_SPEC> {
        CH11_W::new(self, 11)
    }
}
#[doc = "Interrupt Enable for irq0  

You can [`read`](crate::Reg::read) this register and get [`irq0_inte::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`irq0_inte::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IRQ0_INTE_SPEC;
impl crate::RegisterSpec for IRQ0_INTE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irq0_inte::R`](R) reader structure"]
impl crate::Readable for IRQ0_INTE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`irq0_inte::W`](W) writer structure"]
impl crate::Writable for IRQ0_INTE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IRQ0_INTE to value 0"]
impl crate::Resettable for IRQ0_INTE_SPEC {
