...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8(&mut self) -> CH8_W<INTR_SPEC> {
        CH8_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn ch9(&mut self) -> CH9_W<INTR_SPEC> {
        CH9_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn ch10(&mut self) -> CH10_W<INTR_SPEC> {
        CH10_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn ch11(&mut self) -> CH11_W<INTR_SPEC> {
        CH11_W::new(self, 11)
    }
}
#[doc = "Raw Interrupts  
