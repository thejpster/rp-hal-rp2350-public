#[doc = "Register `IRQ1_INTF` reader"]
pub type R = crate::R<IRQ1_INTF_SPEC>;
#[doc = "Register `IRQ1_INTF` writer"]
pub type W = crate::W<IRQ1_INTF_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`irq1_intf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`irq1_intf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IRQ1_INTF_SPEC;
impl crate::RegisterSpec for IRQ1_INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irq1_intf::R`](R) reader structure"]
impl crate::Readable for IRQ1_INTF_SPEC {}
