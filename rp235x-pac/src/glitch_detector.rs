...
impl RegisterBlock {
    #[doc = "0x00 - Forcibly arm the glitch detectors, if they are not already armed by OTP. When armed, any individual detector trigger will cause a restart of the switched core power domain's power-on reset state machine.  
 ...
 This register is Secure read/write only."]
    ...
    #[doc = "0x08 - Adjust the sensitivity of glitch detectors to values other than their OTP-provided defaults.  
 ...
 This register is Secure read/write only."]
    ...
    #[doc = "0x10 - Set when a detector output triggers. Write-1-clear.  
 ...
 This register is Secure read/write only."]
    ...
    #[doc = "0x14 - Simulate the firing of one or more detectors. Writing ones to this register will set the matching bits in STATUS_TRIG.  
...
#[doc = "ARM (rw) register accessor: Forcibly arm the glitch detectors, if they are not already armed by OTP. When armed, any individual detector trigger will cause a restart of the switched core power domain's power-on reset state machine.  
...
#[doc = ""]
pub mod disarm;
#[doc = "SENSITIVITY (rw) register accessor: Adjust the sensitivity of glitch detectors to values other than their OTP-provided defaults.  
...
#[doc = ""]
pub mod lock;
#[doc = "TRIG_STATUS (rw) register accessor: Set when a detector output triggers. Write-1-clear.  
...
#[doc = "Set when a detector output triggers. Write-1-clear.  
 ...
 This register is Secure read/write only."]
pub mod trig_status;
#[doc = "TRIG_FORCE (rw) register accessor: Simulate the firing of one or more detectors. Writing ones to this register will set the matching bits in STATUS_TRIG.  
