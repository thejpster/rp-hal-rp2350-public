...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_level_low(&mut self) -> USBPHY_DP_LEVEL_LOW_W<PROC0_INTE_SPEC> {
        USBPHY_DP_LEVEL_LOW_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_level_high(&mut self) -> USBPHY_DP_LEVEL_HIGH_W<PROC0_INTE_SPEC> {
        USBPHY_DP_LEVEL_HIGH_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_low(&mut self) -> USBPHY_DP_EDGE_LOW_W<PROC0_INTE_SPEC> {
        USBPHY_DP_EDGE_LOW_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_high(&mut self) -> USBPHY_DP_EDGE_HIGH_W<PROC0_INTE_SPEC> {
        USBPHY_DP_EDGE_HIGH_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_level_low(&mut self) -> USBPHY_DM_LEVEL_LOW_W<PROC0_INTE_SPEC> {
        USBPHY_DM_LEVEL_LOW_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_level_high(&mut self) -> USBPHY_DM_LEVEL_HIGH_W<PROC0_INTE_SPEC> {
        USBPHY_DM_LEVEL_HIGH_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_low(&mut self) -> USBPHY_DM_EDGE_LOW_W<PROC0_INTE_SPEC> {
        USBPHY_DM_EDGE_LOW_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_high(&mut self) -> USBPHY_DM_EDGE_HIGH_W<PROC0_INTE_SPEC> {
