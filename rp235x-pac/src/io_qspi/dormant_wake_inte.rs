...
#[doc = "Field `USBPHY_DP_LEVEL_LOW` writer - "]
pub type USBPHY_DP_LEVEL_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DP_LEVEL_HIGH` reader - "]
pub type USBPHY_DP_LEVEL_HIGH_R = crate::BitReader;
#[doc = "Field `USBPHY_DP_LEVEL_HIGH` writer - "]
pub type USBPHY_DP_LEVEL_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DP_EDGE_LOW` reader - "]
pub type USBPHY_DP_EDGE_LOW_R = crate::BitReader;
#[doc = "Field `USBPHY_DP_EDGE_LOW` writer - "]
pub type USBPHY_DP_EDGE_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DP_EDGE_HIGH` reader - "]
pub type USBPHY_DP_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `USBPHY_DP_EDGE_HIGH` writer - "]
pub type USBPHY_DP_EDGE_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DM_LEVEL_LOW` reader - "]
pub type USBPHY_DM_LEVEL_LOW_R = crate::BitReader;
#[doc = "Field `USBPHY_DM_LEVEL_LOW` writer - "]
pub type USBPHY_DM_LEVEL_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USBPHY_DM_LEVEL_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DM_EDGE_LOW` reader - "]
pub type USBPHY_DM_EDGE_LOW_R = crate::BitReader;
#[doc = "Field `USBPHY_DM_EDGE_LOW` writer - "]
pub type USBPHY_DM_EDGE_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USBPHY_DM_EDGE_HIGH` reader - "]
pub type USBPHY_DM_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `USBPHY_DM_EDGE_HIGH` writer - "]
pub type USBPHY_DM_EDGE_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_level_low(&mut self) -> USBPHY_DP_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DP_LEVEL_LOW_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_level_high(&mut self) -> USBPHY_DP_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DP_LEVEL_HIGH_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_low(&mut self) -> USBPHY_DP_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DP_EDGE_LOW_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_high(&mut self) -> USBPHY_DP_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DP_EDGE_HIGH_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_level_low(&mut self) -> USBPHY_DM_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DM_LEVEL_LOW_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_level_high(&mut self) -> USBPHY_DM_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DM_LEVEL_HIGH_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_low(&mut self) -> USBPHY_DM_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DM_EDGE_LOW_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_high(&mut self) -> USBPHY_DM_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC> {
        USBPHY_DM_EDGE_HIGH_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sclk_level_low(
        ...
        GPIO_QSPI_SCLK_LEVEL_LOW_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
