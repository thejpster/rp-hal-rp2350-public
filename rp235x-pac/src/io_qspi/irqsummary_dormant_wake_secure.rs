#[doc = "Register `IRQSUMMARY_DORMANT_WAKE_SECURE` reader"]
pub type R = crate::R<IRQSUMMARY_DORMANT_WAKE_SECURE_SPEC>;
#[doc = "Register `IRQSUMMARY_DORMANT_WAKE_SECURE` writer"]
pub type W = crate::W<IRQSUMMARY_DORMANT_WAKE_SECURE_SPEC>;
...
pub struct IRQSUMMARY_DORMANT_WAKE_SECURE_SPEC;
impl crate::RegisterSpec for IRQSUMMARY_DORMANT_WAKE_SECURE_SPEC {
    type Ux = u32;
}
...
#[doc = "`write(|w| ..)` method takes [`irqsummary_dormant_wake_secure::W`](W) writer structure"]
impl crate::Writable for IRQSUMMARY_DORMANT_WAKE_SECURE_SPEC {
