#[doc = "Register `USBPHY_DP_CTRL` reader"]
pub type R = crate::R<USBPHY_DP_CTRL_SPEC>;
#[doc = "Register `USBPHY_DP_CTRL` writer"]
pub type W = crate::W<USBPHY_DP_CTRL_SPEC>;
...
impl FUNCSEL_R {
    ...
    pub const fn variant(&self) -> Option<FUNCSEL_A> {
        match self.bits {
            2 => Some(FUNCSEL_A::UART1_TX),
            3 => Some(FUNCSEL_A::I2C0_SDA),
            5 => Some(FUNCSEL_A::SIOB_PROC_56),
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn is_siob_proc_56(&self) -> bool {
        *self == FUNCSEL_A::SIOB_PROC_56
    }
    #[doc = "`11111`"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn siob_proc_56(self) -> &'a mut crate::W<REG> {
        self.variant(FUNCSEL_A::SIOB_PROC_56)
    }
    #[doc = "`11111`"]
    #[inline(always)]
...
You can [`read`](crate::Reg::read) this register and get [`usbphy_dp_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usbphy_dp_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USBPHY_DP_CTRL_SPEC;
impl crate::RegisterSpec for USBPHY_DP_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usbphy_dp_ctrl::R`](R) reader structure"]
impl crate::Readable for USBPHY_DP_CTRL_SPEC {}
