#[doc = "Register `USBPHY_DP_STATUS` reader"]
pub type R = crate::R<USBPHY_DP_STATUS_SPEC>;
#[doc = "Register `USBPHY_DP_STATUS` writer"]
pub type W = crate::W<USBPHY_DP_STATUS_SPEC>;
...
pub struct USBPHY_DP_STATUS_SPEC;
impl crate::RegisterSpec for USBPHY_DP_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usbphy_dp_status::R`](R) reader structure"]
impl crate::Readable for USBPHY_DP_STATUS_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usbphy_dp_status::W`](W) writer structure"]
impl crate::Writable for USBPHY_DP_STATUS_SPEC {
