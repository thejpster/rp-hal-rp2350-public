...
#[doc = "Register `USBPHY_DM_STATUS` writer"]
pub type W = crate::W<USBPHY_DM_STATUS_SPEC>;
...
#[doc = "`write(|w| ..)` method takes [`usbphy_dm_status::W`](W) writer structure"]
impl crate::Writable for USBPHY_DM_STATUS_SPEC {
