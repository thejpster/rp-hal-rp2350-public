#[doc = "Register `IRQSUMMARY_PROC1_NONSECURE` reader"]
pub type R = crate::R<IRQSUMMARY_PROC1_NONSECURE_SPEC>;
#[doc = "Register `IRQSUMMARY_PROC1_NONSECURE` writer"]
pub type W = crate::W<IRQSUMMARY_PROC1_NONSECURE_SPEC>;
...
pub struct IRQSUMMARY_PROC1_NONSECURE_SPEC;
impl crate::RegisterSpec for IRQSUMMARY_PROC1_NONSECURE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irqsummary_proc1_nonsecure::R`](R) reader structure"]
impl crate::Readable for IRQSUMMARY_PROC1_NONSECURE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`irqsummary_proc1_nonsecure::W`](W) writer structure"]
impl crate::Writable for IRQSUMMARY_PROC1_NONSECURE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IRQSUMMARY_PROC1_NONSECURE to value 0"]
impl crate::Resettable for IRQSUMMARY_PROC1_NONSECURE_SPEC {
