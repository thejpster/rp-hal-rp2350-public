...
pub type USBPHY_DP_EDGE_LOW_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `USBPHY_DP_EDGE_HIGH` reader - "]
pub type USBPHY_DP_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `USBPHY_DP_EDGE_HIGH` writer - "]
pub type USBPHY_DP_EDGE_HIGH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type USBPHY_DM_EDGE_LOW_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `USBPHY_DM_EDGE_HIGH` reader - "]
pub type USBPHY_DM_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `USBPHY_DM_EDGE_HIGH` writer - "]
pub type USBPHY_DM_EDGE_HIGH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_low(&mut self) -> USBPHY_DP_EDGE_LOW_W<INTR_SPEC> {
        USBPHY_DP_EDGE_LOW_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dp_edge_high(&mut self) -> USBPHY_DP_EDGE_HIGH_W<INTR_SPEC> {
        USBPHY_DP_EDGE_HIGH_W::new(self, 3)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_low(&mut self) -> USBPHY_DM_EDGE_LOW_W<INTR_SPEC> {
        USBPHY_DM_EDGE_LOW_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn usbphy_dm_edge_high(&mut self) -> USBPHY_DM_EDGE_HIGH_W<INTR_SPEC> {
