...
#[doc = "Field `DS0_RANDOM` reader - Randomises the stage 0 drive strength"]
pub type DS0_RANDOM_R = crate::BitReader;
#[doc = "Field `DS0_RANDOM` writer - Randomises the stage 0 drive strength"]
pub type DS0_RANDOM_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `DS1_RANDOM` reader - Randomises the stage 1 drive strength"]
pub type DS1_RANDOM_R = crate::BitReader;
#[doc = "Field `DS1_RANDOM` writer - Randomises the stage 1 drive strength"]
pub type DS1_RANDOM_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ds0_random(&self) -> DS0_RANDOM_R {
        DS0_RANDOM_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn ds1_random(&self) -> DS1_RANDOM_R {
        DS1_RANDOM_R::new(((self.bits >> 7) & 1) != 0)
    }
