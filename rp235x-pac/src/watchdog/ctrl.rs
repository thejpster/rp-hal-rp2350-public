...
#[doc = "Field `TIME` reader - Indicates the time in usec before a watchdog reset will be triggered"]
...
impl R {
    #[doc = "Bits 0:23 - Indicates the time in usec before a watchdog reset will be triggered"]
    #[inline(always)]
