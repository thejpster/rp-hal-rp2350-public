#[doc = "Register `PWRUP1` reader"]
pub type R = crate::R<PWRUP1_SPEC>;
#[doc = "Register `PWRUP1` writer"]
pub type W = crate::W<PWRUP1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`pwrup1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwrup1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PWRUP1_SPEC;
impl crate::RegisterSpec for PWRUP1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrup1::R`](R) reader structure"]
impl crate::Readable for PWRUP1_SPEC {}
...
impl crate::Resettable for PWRUP1_SPEC {
