#[doc = "Register `VREG_LP_EXIT` reader"]
pub type R = crate::R<VREG_LP_EXIT_SPEC>;
#[doc = "Register `VREG_LP_EXIT` writer"]
pub type W = crate::W<VREG_LP_EXIT_SPEC>;
...
#[doc = "Field `MODE` reader - selects either normal (switching) mode or low power (linear) mode  
 low power mode can only be selected for output voltages up to 1.3V  
 0 = normal mode (switching)  
 1 = low power mode (linear)"]
pub type MODE_R = crate::BitReader;
#[doc = "Field `MODE` writer - selects either normal (switching) mode or low power (linear) mode  
 low power mode can only be selected for output voltages up to 1.3V  
 0 = normal mode (switching)  
 1 = low power mode (linear)"]
...
impl R {
 ...
 0=not in high impedance mode, 1=in high impedance mode"]
    ...
    #[doc = "Bit 2 - selects either normal (switching) mode or low power (linear) mode  
 low power mode can only be selected for output voltages up to 1.3V  
 0 = normal mode (switching)  
 1 = low power mode (linear)"]
    #[inline(always)]
    ...
    #[doc = "Bits 4:8 - output voltage select  
 the regulator output voltage is limited to 1.3V unless the voltage limit  
 is disabled using the disable_voltage_limit field in the vreg_ctrl register  
 00000 - 0.55V  
 00001 - 0.60V  
...
pub struct VREG_LP_EXIT_SPEC;
impl crate::RegisterSpec for VREG_LP_EXIT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vreg_lp_exit::R`](R) reader structure"]
impl crate::Readable for VREG_LP_EXIT_SPEC {}
