#[doc = "Register `EXT_CTRL1` reader"]
pub type R = crate::R<EXT_CTRL1_SPEC>;
#[doc = "Register `EXT_CTRL1` writer"]
pub type W = crate::W<EXT_CTRL1_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`ext_ctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ext_ctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EXT_CTRL1_SPEC;
impl crate::RegisterSpec for EXT_CTRL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ext_ctrl1::R`](R) reader structure"]
impl crate::Readable for EXT_CTRL1_SPEC {}
