...
#[doc = "Field `DOUBLE_TAP` reader - This flag is not reset by RUN. It tells bootcode to go into the bootloader and provides an alternative to the double tap method."]
pub type DOUBLE_TAP_R = crate::BitReader;
#[doc = "Field `DOUBLE_TAP` writer - This flag is not reset by RUN. It tells bootcode to go into the bootloader and provides an alternative to the double tap method."]
pub type DOUBLE_TAP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESCUE_FLAG` reader - This is set by a rescue reset from the RP-AP.  
...
#[doc = "Field `RESCUE_FLAG` writer - This is set by a rescue reset from the RP-AP.  
 Its purpose is to halt before the bootrom before booting from flash in order to recover from a boot lock-up.  
 The debugger can then attach once the bootrom has been halted and flash some working code that does not lock up."]
pub type RESCUE_FLAG_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `HAD_POR` reader - Last reset was from the power-on reset  
 This resets:  
 double_tap flag yes  
 DP yes  
 RPAP yes  
...
#[doc = "Field `HAD_BOR` reader - Last reset was from the brown-out detection block  
 This resets:  
 double_tap flag yes  
 DP yes  
 RPAP yes  
...
#[doc = "Field `HAD_RUN_LOW` reader - Last reset was from the RUN pin  
 This resets:  
 double_tap flag no  
 DP yes  
 RPAP yes  
...
#[doc = "Field `HAD_DP_RESET_REQ` reader - Last reset was an reset request from the arm debugger  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_RESCUE` reader - Last reset was a rescue reset from the debugger  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_WATCHDOG_RESET_POWMAN_ASYNC` reader - Last reset was a watchdog timeout which was configured to reset the power manager asynchronously  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_WATCHDOG_RESET_POWMAN` reader - Last reset was a watchdog timeout which was configured to reset the power manager  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_WATCHDOG_RESET_SWCORE` reader - Last reset was a watchdog timeout which was configured to reset the switched-core  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_GLITCH_DETECT` reader - Last reset was due to a power supply glitch  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
#[doc = "Field `HAD_WATCHDOG_RESET_RSM` reader - Last reset was a watchdog timeout which was configured to reset the reset state machine  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
...
impl R {
    #[doc = "Bit 0 - This flag is not reset by RUN. It tells bootcode to go into the bootloader and provides an alternative to the double tap method."]
    #[inline(always)]
    pub fn double_tap(&self) -> DOUBLE_TAP_R {
        DOUBLE_TAP_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 4 - This is set by a rescue reset from the RP-AP.  
 Its purpose is to halt before the bootrom before booting from flash in order to recover from a boot lock-up.  
 The debugger can then attach once the bootrom has been halted and flash some working code that does not lock up."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Last reset was from the power-on reset  
 This resets:  
 double_tap flag yes  
 DP yes  
 RPAP yes  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 17 - Last reset was from the brown-out detection block  
 This resets:  
 double_tap flag yes  
 DP yes  
 RPAP yes  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 18 - Last reset was from the RUN pin  
 This resets:  
 double_tap flag no  
 DP yes  
 RPAP yes  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 19 - Last reset was an reset request from the arm debugger  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 21 - Last reset was a rescue reset from the debugger  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 22 - Last reset was a watchdog timeout which was configured to reset the power manager asynchronously  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 23 - Last reset was a watchdog timeout which was configured to reset the power manager  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 24 - Last reset was a watchdog timeout which was configured to reset the switched-core  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 25 - Last reset was a switched core powerdown  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 then starts the power sequencer"]
    ...
    #[doc = "Bit 26 - Last reset was due to a power supply glitch  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 and does not change the power state"]
    ...
    #[doc = "Bit 27 - Last reset was a system reset from the hazard debugger  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
 ...
 and does not change the power state"]
    ...
    #[doc = "Bit 28 - Last reset was a watchdog timeout which was configured to reset the reset state machine  
 This resets:  
 double_tap flag no  
 DP no  
 RPAP no  
