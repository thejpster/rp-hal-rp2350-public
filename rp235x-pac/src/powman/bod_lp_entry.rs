#[doc = "Register `BOD_LP_ENTRY` reader"]
pub type R = crate::R<BOD_LP_ENTRY_SPEC>;
#[doc = "Register `BOD_LP_ENTRY` writer"]
pub type W = crate::W<BOD_LP_ENTRY_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`bod_lp_entry::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bod_lp_entry::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BOD_LP_ENTRY_SPEC;
impl crate::RegisterSpec for BOD_LP_ENTRY_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bod_lp_entry::R`](R) reader structure"]
impl crate::Readable for BOD_LP_ENTRY_SPEC {}
