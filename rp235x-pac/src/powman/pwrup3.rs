#[doc = "Register `PWRUP3` reader"]
pub type R = crate::R<PWRUP3_SPEC>;
#[doc = "Register `PWRUP3` writer"]
pub type W = crate::W<PWRUP3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn direction(&mut self) -> DIRECTION_W<PWRUP3_SPEC> {
        DIRECTION_W::new(self, 7)
    }
    #[doc = "Bit 8 - Edge or level detect. Edge will detect a 0 to 1 transition (or 1 to 0 transition). Level will detect a 1 or 0. Both types of event get latched into the current_pwrup_req register."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<PWRUP3_SPEC> {
        MODE_W::new(self, 8)
    }
    #[doc = "Bit 9 - Status of gpio wakeup. Write to 1 to clear a latched edge detect."]
    #[inline(always)]
    #[must_use]
    pub fn status(&mut self) -> STATUS_W<PWRUP3_SPEC> {
        STATUS_W::new(self, 9)
    }
}
...
impl crate::RegisterSpec for PWRUP3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrup3::R`](R) reader structure"]
impl crate::Readable for PWRUP3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pwrup3::W`](W) writer structure"]
impl crate::Writable for PWRUP3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0200;
}
#[doc = "`reset()` method sets PWRUP3 to value 0x3f"]
impl crate::Resettable for PWRUP3_SPEC {
