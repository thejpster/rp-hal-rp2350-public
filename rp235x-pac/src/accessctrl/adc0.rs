...
pub type R = crate::R<ADC0_SPEC>;
#[doc = "Register `ADC0` writer"]
pub type W = crate::W<ADC0_SPEC>;
#[doc = "Field `NSU` reader - If 1, and NSP is also set, ADC0 can be accessed from a Non-secure, Unprivileged context. This bit is writable from a Non-secure, Privileged context, if and only if the NSP bit is set."]
pub type NSU_R = crate::BitReader;
#[doc = "Field `NSU` writer - If 1, and NSP is also set, ADC0 can be accessed from a Non-secure, Unprivileged context. This bit is writable from a Non-secure, Privileged context, if and only if the NSP bit is set."]
pub type NSU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NSP` reader - If 1, ADC0 can be accessed from a Non-secure, Privileged context."]
pub type NSP_R = crate::BitReader;
#[doc = "Field `NSP` writer - If 1, ADC0 can be accessed from a Non-secure, Privileged context."]
pub type NSP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SU` reader - If 1, and SP is also set, ADC0 can be accessed from a Secure, Unprivileged context."]
pub type SU_R = crate::BitReader;
#[doc = "Field `SU` writer - If 1, and SP is also set, ADC0 can be accessed from a Secure, Unprivileged context."]
pub type SU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SP` reader - If 1, ADC0 can be accessed from a Secure, Privileged context."]
pub type SP_R = crate::BitReader;
#[doc = "Field `SP` writer - If 1, ADC0 can be accessed from a Secure, Privileged context."]
pub type SP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE0` reader - If 1, ADC0 can be accessed by core 0, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type CORE0_R = crate::BitReader;
#[doc = "Field `CORE0` writer - If 1, ADC0 can be accessed by core 0, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type CORE0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE1` reader - If 1, ADC0 can be accessed by core 1, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type CORE1_R = crate::BitReader;
#[doc = "Field `CORE1` writer - If 1, ADC0 can be accessed by core 1, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type CORE1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DMA` reader - If 1, ADC0 can be accessed by the DMA, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type DMA_R = crate::BitReader;
#[doc = "Field `DMA` writer - If 1, ADC0 can be accessed by the DMA, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type DMA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DBG` reader - If 1, ADC0 can be accessed by the debugger, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
pub type DBG_R = crate::BitReader;
#[doc = "Field `DBG` writer - If 1, ADC0 can be accessed by the debugger, at security/privilege levels permitted by SP/NSP/SU/NSU in this register."]
...
You can [`read`](crate::Reg::read) this register and get [`adc0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets ADC0 to value 0xfc"]
