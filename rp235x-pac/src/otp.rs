...
impl RegisterBlock {
    #[doc = "0x00 - Software lock register for page 0.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x04 - Software lock register for page 1.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x08 - Software lock register for page 2.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x0c - Software lock register for page 3.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x10 - Software lock register for page 4.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x14 - Software lock register for page 5.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x18 - Software lock register for page 6.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x1c - Software lock register for page 7.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x20 - Software lock register for page 8.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x24 - Software lock register for page 9.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x28 - Software lock register for page 10.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x2c - Software lock register for page 11.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x30 - Software lock register for page 12.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x34 - Software lock register for page 13.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x38 - Software lock register for page 14.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x3c - Software lock register for page 15.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x40 - Software lock register for page 16.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x44 - Software lock register for page 17.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x48 - Software lock register for page 18.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x4c - Software lock register for page 19.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x50 - Software lock register for page 20.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x54 - Software lock register for page 21.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x58 - Software lock register for page 22.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x5c - Software lock register for page 23.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x60 - Software lock register for page 24.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x64 - Software lock register for page 25.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x68 - Software lock register for page 26.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x6c - Software lock register for page 27.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x70 - Software lock register for page 28.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x74 - Software lock register for page 29.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x78 - Software lock register for page 30.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x7c - Software lock register for page 31.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x80 - Software lock register for page 32.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x84 - Software lock register for page 33.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x88 - Software lock register for page 34.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x8c - Software lock register for page 35.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x90 - Software lock register for page 36.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x94 - Software lock register for page 37.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x98 - Software lock register for page 38.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x9c - Software lock register for page 39.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xa0 - Software lock register for page 40.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xa4 - Software lock register for page 41.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xa8 - Software lock register for page 42.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xac - Software lock register for page 43.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xb0 - Software lock register for page 44.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xb4 - Software lock register for page 45.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xb8 - Software lock register for page 46.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xbc - Software lock register for page 47.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xc0 - Software lock register for page 48.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xc4 - Software lock register for page 49.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xc8 - Software lock register for page 50.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xcc - Software lock register for page 51.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xd0 - Software lock register for page 52.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xd4 - Software lock register for page 53.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xd8 - Software lock register for page 54.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xdc - Software lock register for page 55.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xe0 - Software lock register for page 56.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xe4 - Software lock register for page 57.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xe8 - Software lock register for page 58.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xec - Software lock register for page 59.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xf0 - Software lock register for page 60.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xf4 - Software lock register for page 61.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xf8 - Software lock register for page 62.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0xfc - Software lock register for page 63.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
    ...
    #[doc = "0x130 - Controls availale only during production_mode = 0"]
    #[inline(always)]
    pub const fn prod0_ctl(&self) -> &PROD0_CTL {
        &self.prod0_ctl
    }
    ...
    #[doc = "0x150 - Enable a debug feature that has been disabled. Debug features are disabled if one of the relevant critical boot flags is set in OTP (DEBUG_DISABLE or SECURE_DEBUG_DISABLE), OR if a debug key is marked valid in OTP, and the matching key value has not been supplied over SWD.  
 ...
 - If both debug keys have been registered, and the Secure key's value (key 5) has been supplied over SWD, then no debug features are disabled by the key mechanism. However, note that in this case debug features may still be disabled by the critical boot flags."]
    ...
    #[doc = "0x158 - Architecture select (Arm/RISC-V). The default and allowable values of this register are constrained by the critical boot flags.  
 ...
 Note that when an Arm core is deselected, its cold reset domain is also held in reset, since in particular the SYSRESETREQ bit becomes inaccessible once the core is deselected. Note also the RISC-V cores do not have a cold reset domain, since their corresponding controls are located in the Debug Module."]
    ...
    #[doc = "0x160 - Tell the bootrom to ignore scratch register boot vectors (both power manager and watchdog) on the next power up.  
...
#[doc = "SW_LOCK0 (rw) register accessor: Software lock register for page 0.  
...
#[doc = "Software lock register for page 0.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock0;
#[doc = "SW_LOCK1 (rw) register accessor: Software lock register for page 1.  
...
#[doc = "Software lock register for page 1.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock1;
#[doc = "SW_LOCK2 (rw) register accessor: Software lock register for page 2.  
...
#[doc = "Software lock register for page 2.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock2;
#[doc = "SW_LOCK3 (rw) register accessor: Software lock register for page 3.  
...
#[doc = "Software lock register for page 3.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock3;
#[doc = "SW_LOCK4 (rw) register accessor: Software lock register for page 4.  
...
#[doc = "Software lock register for page 4.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock4;
#[doc = "SW_LOCK5 (rw) register accessor: Software lock register for page 5.  
...
#[doc = "Software lock register for page 5.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock5;
#[doc = "SW_LOCK6 (rw) register accessor: Software lock register for page 6.  
...
#[doc = "Software lock register for page 6.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock6;
#[doc = "SW_LOCK7 (rw) register accessor: Software lock register for page 7.  
...
#[doc = "Software lock register for page 7.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock7;
#[doc = "SW_LOCK8 (rw) register accessor: Software lock register for page 8.  
...
#[doc = "Software lock register for page 8.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock8;
#[doc = "SW_LOCK9 (rw) register accessor: Software lock register for page 9.  
...
#[doc = "Software lock register for page 9.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock9;
#[doc = "SW_LOCK10 (rw) register accessor: Software lock register for page 10.  
...
#[doc = "Software lock register for page 10.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock10;
#[doc = "SW_LOCK11 (rw) register accessor: Software lock register for page 11.  
...
#[doc = "Software lock register for page 11.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock11;
#[doc = "SW_LOCK12 (rw) register accessor: Software lock register for page 12.  
...
#[doc = "Software lock register for page 12.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock12;
#[doc = "SW_LOCK13 (rw) register accessor: Software lock register for page 13.  
...
#[doc = "Software lock register for page 13.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock13;
#[doc = "SW_LOCK14 (rw) register accessor: Software lock register for page 14.  
...
#[doc = "Software lock register for page 14.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock14;
#[doc = "SW_LOCK15 (rw) register accessor: Software lock register for page 15.  
...
#[doc = "Software lock register for page 15.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock15;
#[doc = "SW_LOCK16 (rw) register accessor: Software lock register for page 16.  
...
#[doc = "Software lock register for page 16.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock16;
#[doc = "SW_LOCK17 (rw) register accessor: Software lock register for page 17.  
...
#[doc = "Software lock register for page 17.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock17;
#[doc = "SW_LOCK18 (rw) register accessor: Software lock register for page 18.  
...
#[doc = "Software lock register for page 18.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock18;
#[doc = "SW_LOCK19 (rw) register accessor: Software lock register for page 19.  
...
#[doc = "Software lock register for page 19.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock19;
#[doc = "SW_LOCK20 (rw) register accessor: Software lock register for page 20.  
...
#[doc = "Software lock register for page 20.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock20;
#[doc = "SW_LOCK21 (rw) register accessor: Software lock register for page 21.  
...
#[doc = "Software lock register for page 21.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock21;
#[doc = "SW_LOCK22 (rw) register accessor: Software lock register for page 22.  
...
#[doc = "Software lock register for page 22.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock22;
#[doc = "SW_LOCK23 (rw) register accessor: Software lock register for page 23.  
...
#[doc = "Software lock register for page 23.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock23;
#[doc = "SW_LOCK24 (rw) register accessor: Software lock register for page 24.  
...
#[doc = "Software lock register for page 24.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock24;
#[doc = "SW_LOCK25 (rw) register accessor: Software lock register for page 25.  
...
#[doc = "Software lock register for page 25.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock25;
#[doc = "SW_LOCK26 (rw) register accessor: Software lock register for page 26.  
...
#[doc = "Software lock register for page 26.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock26;
#[doc = "SW_LOCK27 (rw) register accessor: Software lock register for page 27.  
...
#[doc = "Software lock register for page 27.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock27;
#[doc = "SW_LOCK28 (rw) register accessor: Software lock register for page 28.  
...
#[doc = "Software lock register for page 28.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock28;
#[doc = "SW_LOCK29 (rw) register accessor: Software lock register for page 29.  
...
#[doc = "Software lock register for page 29.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock29;
#[doc = "SW_LOCK30 (rw) register accessor: Software lock register for page 30.  
...
#[doc = "Software lock register for page 30.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock30;
#[doc = "SW_LOCK31 (rw) register accessor: Software lock register for page 31.  
...
#[doc = "Software lock register for page 31.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock31;
#[doc = "SW_LOCK32 (rw) register accessor: Software lock register for page 32.  
...
#[doc = "Software lock register for page 32.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock32;
#[doc = "SW_LOCK33 (rw) register accessor: Software lock register for page 33.  
...
#[doc = "Software lock register for page 33.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock33;
#[doc = "SW_LOCK34 (rw) register accessor: Software lock register for page 34.  
...
#[doc = "Software lock register for page 34.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock34;
#[doc = "SW_LOCK35 (rw) register accessor: Software lock register for page 35.  
...
#[doc = "Software lock register for page 35.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock35;
#[doc = "SW_LOCK36 (rw) register accessor: Software lock register for page 36.  
...
#[doc = "Software lock register for page 36.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock36;
#[doc = "SW_LOCK37 (rw) register accessor: Software lock register for page 37.  
...
#[doc = "Software lock register for page 37.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock37;
#[doc = "SW_LOCK38 (rw) register accessor: Software lock register for page 38.  
...
#[doc = "Software lock register for page 38.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock38;
#[doc = "SW_LOCK39 (rw) register accessor: Software lock register for page 39.  
...
#[doc = "Software lock register for page 39.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock39;
#[doc = "SW_LOCK40 (rw) register accessor: Software lock register for page 40.  
...
#[doc = "Software lock register for page 40.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock40;
#[doc = "SW_LOCK41 (rw) register accessor: Software lock register for page 41.  
...
#[doc = "Software lock register for page 41.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock41;
#[doc = "SW_LOCK42 (rw) register accessor: Software lock register for page 42.  
...
#[doc = "Software lock register for page 42.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock42;
#[doc = "SW_LOCK43 (rw) register accessor: Software lock register for page 43.  
...
#[doc = "Software lock register for page 43.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock43;
#[doc = "SW_LOCK44 (rw) register accessor: Software lock register for page 44.  
...
#[doc = "Software lock register for page 44.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock44;
#[doc = "SW_LOCK45 (rw) register accessor: Software lock register for page 45.  
...
#[doc = "Software lock register for page 45.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock45;
#[doc = "SW_LOCK46 (rw) register accessor: Software lock register for page 46.  
...
#[doc = "Software lock register for page 46.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock46;
#[doc = "SW_LOCK47 (rw) register accessor: Software lock register for page 47.  
...
#[doc = "Software lock register for page 47.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock47;
#[doc = "SW_LOCK48 (rw) register accessor: Software lock register for page 48.  
...
#[doc = "Software lock register for page 48.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock48;
#[doc = "SW_LOCK49 (rw) register accessor: Software lock register for page 49.  
...
#[doc = "Software lock register for page 49.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock49;
#[doc = "SW_LOCK50 (rw) register accessor: Software lock register for page 50.  
...
#[doc = "Software lock register for page 50.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock50;
#[doc = "SW_LOCK51 (rw) register accessor: Software lock register for page 51.  
...
#[doc = "Software lock register for page 51.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock51;
#[doc = "SW_LOCK52 (rw) register accessor: Software lock register for page 52.  
...
#[doc = "Software lock register for page 52.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock52;
#[doc = "SW_LOCK53 (rw) register accessor: Software lock register for page 53.  
...
#[doc = "Software lock register for page 53.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock53;
#[doc = "SW_LOCK54 (rw) register accessor: Software lock register for page 54.  
...
#[doc = "Software lock register for page 54.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock54;
#[doc = "SW_LOCK55 (rw) register accessor: Software lock register for page 55.  
...
#[doc = "Software lock register for page 55.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock55;
#[doc = "SW_LOCK56 (rw) register accessor: Software lock register for page 56.  
...
#[doc = "Software lock register for page 56.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock56;
#[doc = "SW_LOCK57 (rw) register accessor: Software lock register for page 57.  
...
#[doc = "Software lock register for page 57.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock57;
#[doc = "SW_LOCK58 (rw) register accessor: Software lock register for page 58.  
...
#[doc = "Software lock register for page 58.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock58;
#[doc = "SW_LOCK59 (rw) register accessor: Software lock register for page 59.  
...
#[doc = "Software lock register for page 59.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock59;
#[doc = "SW_LOCK60 (rw) register accessor: Software lock register for page 60.  
...
#[doc = "Software lock register for page 60.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock60;
#[doc = "SW_LOCK61 (rw) register accessor: Software lock register for page 61.  
...
#[doc = "Software lock register for page 61.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock61;
#[doc = "SW_LOCK62 (rw) register accessor: Software lock register for page 62.  
...
#[doc = "Software lock register for page 62.  
 ...
 Locks are initialised from the OTP lock pages at reset. This register can be written to further advance the lock state of each page (until next reset), and read to check the current lock state of a page."]
pub mod sw_lock62;
#[doc = "SW_LOCK63 (rw) register accessor: Software lock register for page 63.  
...
#[doc = "SBPI_RDATA_0 (r) register accessor: Read payload bytes 3..0. Once read, the data in the register will automatically clear to 0.  
...
#[doc = "SBPI_RDATA_1 (r) register accessor: Read payload bytes 7..4. Once read, the data in the register will automatically clear to 0.  
...
#[doc = "SBPI_RDATA_2 (r) register accessor: Read payload bytes 11..8. Once read, the data in the register will automatically clear to 0.  
...
#[doc = "SBPI_RDATA_3 (r) register accessor: Read payload bytes 15..12. Once read, the data in the register will automatically clear to 0.  
...
pub mod dbg;
#[doc = "PROD0_CTL (rw) register accessor: Controls availale only during production_mode = 0  

You can [`read`](crate::Reg::read) this register and get [`prod0_ctl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`prod0_ctl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).  

For information about available fields see [`mod@prod0_ctl`]
module"]
pub type PROD0_CTL = crate::Reg<prod0_ctl::PROD0_CTL_SPEC>;
...
pub mod bist;
#[doc = "CRT_KEY_W0 (w) register accessor: Word 0 (bits 31..0) of the key. Write only, read returns 0x0  
...
pub mod crt_key_w0;
#[doc = "CRT_KEY_W1 (w) register accessor: Word 1 (bits 63..32) of the key. Write only, read returns 0x0  
...
pub mod crt_key_w1;
#[doc = "CRT_KEY_W2 (w) register accessor: Word 2 (bits 95..64) of the key. Write only, read returns 0x0  
...
pub mod crt_key_w2;
#[doc = "CRT_KEY_W3 (w) register accessor: Word 3 (bits 127..96) of the key. Write only, read returns 0x0  
...
pub mod crt_key_w3;
#[doc = "CRITICAL (r) register accessor: Quickly check values of critical flags read during boot up  
...
pub mod critical;
#[doc = "KEY_VALID (r) register accessor: Which keys were valid (enrolled) at boot time  
...
pub mod key_valid;
#[doc = "DEBUGEN (rw) register accessor: Enable a debug feature that has been disabled. Debug features are disabled if one of the relevant critical boot flags is set in OTP (DEBUG_DISABLE or SECURE_DEBUG_DISABLE), OR if a debug key is marked valid in OTP, and the matching key value has not been supplied over SWD.  
...
#[doc = "ARCHSEL (rw) register accessor: Architecture select (Arm/RISC-V). The default and allowable values of this register are constrained by the critical boot flags.  
...
#[doc = "Architecture select (Arm/RISC-V). The default and allowable values of this register are constrained by the critical boot flags.  
 ...
 Note that when an Arm core is deselected, its cold reset domain is also held in reset, since in particular the SYSRESETREQ bit becomes inaccessible once the core is deselected. Note also the RISC-V cores do not have a cold reset domain, since their corresponding controls are located in the Debug Module."]
pub mod archsel;
#[doc = "ARCHSEL_STATUS (r) register accessor: Get the current architecture select state of each core. Cores sample the current value of the ARCHSEL register when their warm reset is released, at which point the corresponding bit in this register will also update.  
...
#[doc = "BOOTDIS (rw) register accessor: Tell the bootrom to ignore scratch register boot vectors (both power manager and watchdog) on the next power up.  
