...
#[doc = "STREAM (r) register accessor: Read the XIP stream FIFO (fast bus access to XIP_CTRL_STREAM_FIFO)  
...
pub mod stream;
#[doc = "QMI_DIRECT_TX (w) register accessor: Write to the QMI direct-mode TX FIFO (fast bus access to QMI_DIRECT_TX)  
...
#[doc = "QMI_DIRECT_RX (r) register accessor: Read from the QMI direct-mode RX FIFO (fast bus access to QMI_DIRECT_RX)  
