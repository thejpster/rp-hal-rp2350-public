...
#[doc = "Field `NSU` reader - If 1, and NSP is also set, XIP_CTRL can be accessed from a NonSecure, Unprivileged context.  

 This bit is writable from a NonSecure, Privileged context, if and only if the NSP bit is set."]
pub type NSU_R = crate::BitReader;
#[doc = "Field `NSU` writer - If 1, and NSP is also set, XIP_CTRL can be accessed from a NonSecure, Unprivileged context.  

 This bit is writable from a NonSecure, Privileged context, if and only if the NSP bit is set."]
pub type NSU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `NSP` reader - If 1, XIP_CTRL can be accessed from a NonSecure, Privileged context."]
pub type NSP_R = crate::BitReader;
#[doc = "Field `NSP` writer - If 1, XIP_CTRL can be accessed from a NonSecure, Privileged context."]
...
impl R {
    #[doc = "Bit 0 - If 1, and NSP is also set, XIP_CTRL can be accessed from a NonSecure, Unprivileged context.  
 ...
 This bit is writable from a NonSecure, Privileged context, if and only if the NSP bit is set."]
    ...
    #[doc = "Bit 1 - If 1, XIP_CTRL can be accessed from a NonSecure, Privileged context."]
    #[inline(always)]
