...
//!
//! See [Chapter 4 Section 2](https://example.com/TODO/chapter/is/wrong) of the datasheet for more details
//!
//! ## Usage
//!
//! See [examples/uart.rs](https://github.com/rp-rs/rp-hal/tree/main/rp235x-hal/examples/uart.rs) for a more complete example
//! ```no_run
