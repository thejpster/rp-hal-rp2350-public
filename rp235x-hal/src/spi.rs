...
//!
//! See [Chapter 4 Section 4](https://example.com/TODO/chapter/is/wrong) for more details
//!
//! ## Usage
//!
//! ```no_run
...
///   pinouts for each Spi peripheral can be found in section X.X.X of the rp235x datasheet.
///
